...
int CORR_HISTORY_MINMAX = 286;
int PAWN_CORR_HISTORY_MULTIPLIER = 3423;
int NON_PAWN_CORR_HISTORY_MULTIPLIER = 1928;
int MINOR_CORR_HISTORY_MULTIPLIER = 1531;
int MAJOR_CORR_HISTORY_MULTIPLIER = 1468;
