...
int QUIET_HISTORY_BONUS_MAX = 1361;
int CONT_HISTORY_BONUS_MAX = 1535;
int CAPTURE_HISTORY_MALUS_MAX = 1077;
int QUIET_HISTORY_MALUS_MAX = 1113;
int CONT_HISTORY_MALUS_MAX = 1453;
int CAPTURE_HISTORY_BONUS_MIN = 1511;
int QUIET_HISTORY_BONUS_MIN = 1502;
int CONT_HISTORY_BONUS_MIN = 1467;
int CAPTURE_HISTORY_MALUS_MIN = 1333;
int QUIET_HISTORY_MALUS_MIN = 1422;
int CONT_HISTORY_MALUS_MIN = 1384;
int CORR_HISTORY_MINMAX = 138;
