...
int QUIET_HISTORY_BONUS_MAX = 1208;
int QUIET_HISTORY_BASE_BONUS = 10;
int QUIET_HISTORY_FACTOR_BONUS = 153;
int QUIET_HISTORY_BASE_MALUS = 8;
int QUIET_HISTORY_FACTOR_MALUS = 213;
int QUIET_HISTORY_MAX_TT = 1271;
int QUIET_HISTORY_TT_FACTOR = 133;
int QUIET_HISTORY_TT_BASE = 61;

int CAPTURE_HISTORY_MALUS_MAX = 951;
int CAPTURE_HISTORY_BONUS_MAX = 1482;
int CAPTURE_HISTORY_BASE_BONUS = 10;
int CAPTURE_HISTORY_FACTOR_BONUS = 157;
int CAPTURE_HISTORY_BASE_MALUS = 10;
int CAPTURE_HISTORY_FACTOR_MALUS = 250;

int CONT_HISTORY_MALUS_MAX = 1371;
int CONT_HISTORY_BONUS_MAX = 2272;
int CONT_HISTORY_BASE_BONUS = 9;
int CONT_HISTORY_FACTOR_BONUS = 173;
int CONT_HISTORY_BASE_MALUS = 9;
int CONT_HISTORY_FACTOR_MALUS = 240;

int PAWN_HISTORY_MALUS_MAX = 980;
int PAWN_HISTORY_BONUS_MAX = 1204;
int PAWN_HISTORY_BASE_BONUS = 9;
int PAWN_HISTORY_FACTOR_BONUS = 211;
int PAWN_HISTORY_BASE_MALUS = 9;
int PAWN_HISTORY_FACTOR_MALUS = 179;

int CORR_HISTORY_MINMAX = 306;
int PAWN_CORR_HISTORY_MULTIPLIER = 37;
int NON_PAWN_CORR_HISTORY_MULTIPLIER = 23;

int FIFTY_MOVE_SCALING = 190;
