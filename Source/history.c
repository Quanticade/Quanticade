...
int CAPTURE_HISTORY_BONUS_MAX = 1211;
int QUIET_HISTORY_BONUS_MAX = 1386;
int CONT_HISTORY_BONUS_MAX = 1253;
int CAPTURE_HISTORY_MALUS_MAX = 1284;
int QUIET_HISTORY_MALUS_MAX = 1217;
int CONT_HISTORY_MALUS_MAX = 1249;
int CAPTURE_HISTORY_BONUS_MIN = 1340;
int QUIET_HISTORY_BONUS_MIN = 1292;
int CONT_HISTORY_BONUS_MIN = 1274;
int CAPTURE_HISTORY_MALUS_MIN = 1184;
int QUIET_HISTORY_MALUS_MIN = 1329;
int CONT_HISTORY_MALUS_MIN = 1277;
