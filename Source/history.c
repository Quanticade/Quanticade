...
int QUIET_HISTORY_MALUS_MAX = 1097;
int QUIET_HISTORY_BONUS_MAX = 1306;
int QUIET_HISTORY_BASE_BONUS = 10;
int QUIET_HISTORY_FACTOR_BONUS = 185;
int QUIET_HISTORY_BASE_MALUS = 9;
int QUIET_HISTORY_FACTOR_MALUS = 193;

int CAPTURE_HISTORY_MALUS_MAX = 1001;
int CAPTURE_HISTORY_BONUS_MAX = 1336;
int CAPTURE_HISTORY_BASE_BONUS = 10;
int CAPTURE_HISTORY_FACTOR_BONUS = 188;
int CAPTURE_HISTORY_BASE_MALUS = 10;
int CAPTURE_HISTORY_FACTOR_MALUS = 217;

int CONT_HISTORY_MALUS_MAX = 1475;
int CONT_HISTORY_BONUS_MAX = 1850;
int CONT_HISTORY_BASE_BONUS = 9;
int CONT_HISTORY_FACTOR_BONUS = 181;
int CONT_HISTORY_BASE_MALUS = 10;
int CONT_HISTORY_FACTOR_MALUS = 209;
int CONT_HISTORY_BASE2_BONUS = 10;
int CONT_HISTORY_FACTOR2_BONUS = 205;
int CONT_HISTORY_BASE2_MALUS = 11;
int CONT_HISTORY_FACTOR2_MALUS = 219;
int CONT_HISTORY_BASE4_BONUS = 9;
int CONT_HISTORY_FACTOR4_BONUS = 193;
int CONT_HISTORY_BASE4_MALUS = 10;
int CONT_HISTORY_FACTOR4_MALUS = 209;

int PAWN_HISTORY_MALUS_MAX = 1151;
int PAWN_HISTORY_BONUS_MAX = 1316;
int PAWN_HISTORY_BASE_BONUS = 9;
int PAWN_HISTORY_FACTOR_BONUS = 191;
int PAWN_HISTORY_BASE_MALUS = 10;
int PAWN_HISTORY_FACTOR_MALUS = 214;
