...
int QUIET_HISTORY_MALUS_MAX = 1082;
int QUIET_HISTORY_BONUS_MAX = 1288;
int QUIET_HISTORY_BASE_BONUS = 10;
int QUIET_HISTORY_FACTOR_BONUS = 184;
int QUIET_HISTORY_BASE_MALUS = 9;
int QUIET_HISTORY_FACTOR_MALUS = 195;

int CAPTURE_HISTORY_MALUS_MAX = 1000;
int CAPTURE_HISTORY_BONUS_MAX = 1313;
int CAPTURE_HISTORY_BASE_BONUS = 10;
int CAPTURE_HISTORY_FACTOR_BONUS = 190;
int CAPTURE_HISTORY_BASE_MALUS = 10;
int CAPTURE_HISTORY_FACTOR_MALUS = 212;

int CONT_HISTORY_MALUS_MAX = 1491;
int CONT_HISTORY_BONUS_MAX = 1877;
int CONT_HISTORY_BASE_BONUS = 9;
int CONT_HISTORY_FACTOR_BONUS = 183;
int CONT_HISTORY_BASE_MALUS = 10;
int CONT_HISTORY_FACTOR_MALUS = 215;
int CONT_HISTORY_BASE2_BONUS = 10;
int CONT_HISTORY_FACTOR2_BONUS = 208;
int CONT_HISTORY_BASE2_MALUS = 11;
int CONT_HISTORY_FACTOR2_MALUS = 218;
int CONT_HISTORY_BASE4_BONUS = 9;
int CONT_HISTORY_FACTOR4_BONUS = 193;
int CONT_HISTORY_BASE4_MALUS = 10;
int CONT_HISTORY_FACTOR4_MALUS = 207;

int PAWN_HISTORY_MALUS_MAX = 1161;
int PAWN_HISTORY_BONUS_MAX = 1312;
int PAWN_HISTORY_BASE_BONUS = 9;
int PAWN_HISTORY_FACTOR_BONUS = 189;
...
int NON_PAWN_CORR_HISTORY_MULTIPLIER = 20;
...
void update_corrhist(thread_t *thread, position_t *pos, int16_t static_eval, int16_t score,
  ...
  for (int color = white; color <= black; ++color) {
    thread->non_pawn_correction_history
        [thread->pos.side][color]
        [thread->pos.hash_keys.non_pawn_key[color] & 16383] +=
        scale_corrhist_bonus(
            thread->non_pawn_correction_history
                [thread->pos.side][color]
                [thread->pos.hash_keys.non_pawn_key[color] & 16383],
