...
TUNABLE(int CORR_HISTORY_MINMAX = 355);

TUNABLE(int PAWN_CORR_HISTORY_MULTIPLIER = 3027);
TUNABLE(int NON_PAWN_CORR_HISTORY_MULTIPLIER = 1789);

TUNABLE(int FIFTY_MOVE_SCALING = 218);
TUNABLE(int CORR_HISTORY_BONUS_SCALER = 133);
