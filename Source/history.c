...
int CAPTURE_HISTORY_BONUS_MAX = 1372;
int QUIET_HISTORY_BONUS_MAX = 1427;
int CONT_HISTORY_BONUS_MAX = 1395;
int CAPTURE_HISTORY_MALUS_MAX = 1093;
int QUIET_HISTORY_MALUS_MAX = 1075;
int CONT_HISTORY_MALUS_MAX = 1432;
int CAPTURE_HISTORY_BONUS_MIN = 1595;
int QUIET_HISTORY_BONUS_MIN = 1471;
int CONT_HISTORY_BONUS_MIN = 1389;
int CAPTURE_HISTORY_MALUS_MIN = 1311;
int QUIET_HISTORY_MALUS_MIN = 1310;
int CONT_HISTORY_MALUS_MIN = 1292;
int CORR_HISTORY_MINMAX = 140;
