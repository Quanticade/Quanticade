...
int CAPTURE_HISTORY_BONUS_MAX = 1163;
int QUIET_HISTORY_BONUS_MAX = 1413;
int CONT_HISTORY_BONUS_MAX = 1268;
int CAPTURE_HISTORY_MALUS_MAX = 1271;
int QUIET_HISTORY_MALUS_MAX = 1194;
int CONT_HISTORY_MALUS_MAX = 1205;
int CAPTURE_HISTORY_BONUS_MIN = 1456;
int QUIET_HISTORY_BONUS_MIN = 1262;
int CONT_HISTORY_BONUS_MIN = 1307;
int CAPTURE_HISTORY_MALUS_MIN = 1195;
int QUIET_HISTORY_MALUS_MIN = 1321;
int CONT_HISTORY_MALUS_MIN = 1229;
