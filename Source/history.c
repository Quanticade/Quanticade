...
int QUIET_HISTORY_MALUS_MAX = 979;
int QUIET_HISTORY_BONUS_MAX = 1239;
int QUIET_HISTORY_BASE_BONUS = 11;
int QUIET_HISTORY_FACTOR_BONUS = 147;
int QUIET_HISTORY_BASE_MALUS = 7;
int QUIET_HISTORY_FACTOR_MALUS = 207;
int QUIET_HISTORY_MAX_TT = 1198;
int QUIET_HISTORY_TT_FACTOR = 136;
int QUIET_HISTORY_TT_BASE = 69;

int CAPTURE_HISTORY_MALUS_MAX = 949;
int CAPTURE_HISTORY_BONUS_MAX = 1610;
int CAPTURE_HISTORY_BASE_BONUS = 11;
int CAPTURE_HISTORY_FACTOR_BONUS = 150;
int CAPTURE_HISTORY_BASE_MALUS = 10;
int CAPTURE_HISTORY_FACTOR_MALUS = 230;

int CONT_HISTORY_MALUS_MAX = 1332;
int CONT_HISTORY_BONUS_MAX = 2395;
int CONT_HISTORY_BASE_BONUS = 9;
int CONT_HISTORY_FACTOR_BONUS = 202;
int CONT_HISTORY_BASE_MALUS = 8;
int CONT_HISTORY_FACTOR_MALUS = 258;

int PAWN_HISTORY_MALUS_MAX = 1045;
int PAWN_HISTORY_BONUS_MAX = 1384;
int PAWN_HISTORY_BASE_BONUS = 9;
int PAWN_HISTORY_FACTOR_BONUS = 189;
int PAWN_HISTORY_BASE_MALUS = 9;
int PAWN_HISTORY_FACTOR_MALUS = 143;
