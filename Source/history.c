...
TUNABLE(int PAWN_CORR_HISTORY_MULTIPLIER = 2915);
TUNABLE(int NON_PAWN_CORR_HISTORY_MULTIPLIER = 1784);

TUNABLE(int FIFTY_MOVE_SCALING = 211);
TUNABLE(int CORR_HISTORY_BONUS_SCALER = 149);
