...
int QUIET_HISTORY_MALUS_MAX = 977;
int QUIET_HISTORY_BONUS_MAX = 1166;
int QUIET_HISTORY_BASE_BONUS = 12;
int QUIET_HISTORY_FACTOR_BONUS = 141;
int QUIET_HISTORY_BASE_MALUS = 7;
int QUIET_HISTORY_FACTOR_MALUS = 261;
int QUIET_HISTORY_MAX_TT = 1522;
int QUIET_HISTORY_TT_FACTOR = 103;
int QUIET_HISTORY_TT_BASE = 76;

int CAPTURE_HISTORY_MALUS_MAX = 936;
int CAPTURE_HISTORY_BONUS_MAX = 1408;
int CAPTURE_HISTORY_BASE_BONUS = 11;
int CAPTURE_HISTORY_FACTOR_BONUS = 128;
int CAPTURE_HISTORY_BASE_MALUS = 7;
int CAPTURE_HISTORY_FACTOR_MALUS = 254;

int CONT_HISTORY_MALUS_MAX = 1037;
int CONT_HISTORY_BONUS_MAX = 2355;
int CONT_HISTORY_BASE_BONUS = 9;
int CONT_HISTORY_FACTOR_BONUS = 161;
int CONT_HISTORY_BASE_MALUS = 9;
int CONT_HISTORY_FACTOR_MALUS = 303;

int PAWN_HISTORY_MALUS_MAX = 898;
int PAWN_HISTORY_BONUS_MAX = 1179;
int PAWN_HISTORY_BASE_BONUS = 10;
int PAWN_HISTORY_FACTOR_BONUS = 207;
int PAWN_HISTORY_BASE_MALUS = 8;
int PAWN_HISTORY_FACTOR_MALUS = 144;

int CORR_HISTORY_MINMAX = 343;
int PAWN_CORR_HISTORY_MULTIPLIER = 22;
int NON_PAWN_CORR_HISTORY_MULTIPLIER = 18;

int FIFTY_MOVE_SCALING = 97;
