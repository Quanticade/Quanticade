...
int QUIET_HISTORY_MALUS_MAX = 1053;
int QUIET_HISTORY_BONUS_MAX = 1240;
int QUIET_HISTORY_BASE_BONUS = 11;
int QUIET_HISTORY_FACTOR_BONUS = 141;
int QUIET_HISTORY_BASE_MALUS = 7;
int QUIET_HISTORY_FACTOR_MALUS = 209;
int QUIET_HISTORY_MAX_TT = 1223;
int QUIET_HISTORY_TT_FACTOR = 139;
int QUIET_HISTORY_TT_BASE = 71;

int CAPTURE_HISTORY_MALUS_MAX = 965;
int CAPTURE_HISTORY_BONUS_MAX = 1590;
int CAPTURE_HISTORY_BASE_BONUS = 10;
int CAPTURE_HISTORY_FACTOR_BONUS = 146;
int CAPTURE_HISTORY_BASE_MALUS = 10;
int CAPTURE_HISTORY_FACTOR_MALUS = 246;

int CONT_HISTORY_MALUS_MAX = 1328;
int CONT_HISTORY_BONUS_MAX = 2286;
...
int PAWN_HISTORY_MALUS_MAX = 1007;
int PAWN_HISTORY_BONUS_MAX = 1304;
int PAWN_HISTORY_BASE_BONUS = 9;
int PAWN_HISTORY_FACTOR_BONUS = 189;
int PAWN_HISTORY_BASE_MALUS = 8;
int PAWN_HISTORY_FACTOR_MALUS = 145;
int CORR_HISTORY_MINMAX = 323;

int PAWN_CORR_HISTORY_MULTIPLIER = 35;
int NON_PAWN_CORR_HISTORY_MULTIPLIER = 21;
