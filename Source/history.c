...
int QUIET_HISTORY_MALUS_MAX = 1145;
int QUIET_HISTORY_BONUS_MAX = 1162;
int QUIET_HISTORY_BASE_BONUS = 11;
int QUIET_HISTORY_FACTOR_BONUS = 174;
int QUIET_HISTORY_BASE_MALUS = 9;
int QUIET_HISTORY_FACTOR_MALUS = 221;

int CAPTURE_HISTORY_MALUS_MAX = 1048;
int CAPTURE_HISTORY_BONUS_MAX = 1295;
int CAPTURE_HISTORY_BASE_BONUS = 10;
int CAPTURE_HISTORY_FACTOR_BONUS = 189;
int CAPTURE_HISTORY_BASE_MALUS = 11;
int CAPTURE_HISTORY_FACTOR_MALUS = 217;

int CONT_HISTORY_MALUS_MAX = 1370;
int CONT_HISTORY_BONUS_MAX = 2004;
int CONT_HISTORY_BASE_BONUS = 9;
int CONT_HISTORY_FACTOR_BONUS = 176;
int CONT_HISTORY_BASE_MALUS = 10;
int CONT_HISTORY_FACTOR_MALUS = 199;
int CONT_HISTORY_BASE2_BONUS = 10;
int CONT_HISTORY_FACTOR2_BONUS = 204;
int CONT_HISTORY_BASE2_MALUS = 11;
int CONT_HISTORY_FACTOR2_MALUS = 240;
int CONT_HISTORY_BASE4_BONUS = 9;
int CONT_HISTORY_FACTOR4_BONUS = 179;
int CONT_HISTORY_BASE4_MALUS = 9;
int CONT_HISTORY_FACTOR4_MALUS = 207;

int PAWN_HISTORY_MALUS_MAX = 1132;
int PAWN_HISTORY_BONUS_MAX = 1345;
...
int MAJOR_CORR_HISTORY_MULTIPLIER = 25;
