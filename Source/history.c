...
int QUIET_HISTORY_MALUS_MAX = 1086;
int QUIET_HISTORY_BONUS_MAX = 1396;
int QUIET_HISTORY_BASE_BONUS = 10;
int QUIET_HISTORY_FACTOR_BONUS = 208;
int QUIET_HISTORY_BASE_MALUS = 10;
int QUIET_HISTORY_FACTOR_MALUS = 207;

int CAPTURE_HISTORY_MALUS_MAX = 1034;
int CAPTURE_HISTORY_BONUS_MAX = 1247;
int CAPTURE_HISTORY_BASE_BONUS = 10;
int CAPTURE_HISTORY_FACTOR_BONUS = 196;
int CAPTURE_HISTORY_BASE_MALUS = 9;
int CAPTURE_HISTORY_FACTOR_MALUS = 201;

int CONT_HISTORY_MALUS_MAX = 1473;
int CONT_HISTORY_BONUS_MAX = 1710;
int CONT_HISTORY_BASE_BONUS = 10;
int CONT_HISTORY_FACTOR_BONUS = 182;
int CONT_HISTORY_BASE_MALUS = 10;
int CONT_HISTORY_FACTOR_MALUS = 207;
int CONT_HISTORY_BASE2_BONUS = 10;
int CONT_HISTORY_FACTOR2_BONUS = 184;
int CONT_HISTORY_BASE2_MALUS = 10;
int CONT_HISTORY_FACTOR2_MALUS = 205;
int CONT_HISTORY_BASE4_BONUS = 9;
int CONT_HISTORY_FACTOR4_BONUS = 181;
int CONT_HISTORY_BASE4_MALUS = 11;
int CONT_HISTORY_FACTOR4_MALUS = 198;

int PAWN_HISTORY_MALUS_MAX = 1135;
int PAWN_HISTORY_BONUS_MAX = 1399;
int PAWN_HISTORY_BASE_BONUS = 9;
int PAWN_HISTORY_FACTOR_BONUS = 208;
int PAWN_HISTORY_BASE_MALUS = 9;
int PAWN_HISTORY_FACTOR_MALUS = 186;
