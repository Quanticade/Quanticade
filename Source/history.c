...
int QUIET_HISTORY_MALUS_MAX = 1011;
int QUIET_HISTORY_BONUS_MAX = 1226;
int QUIET_HISTORY_BASE_BONUS = 11;
int QUIET_HISTORY_FACTOR_BONUS = 148;
int QUIET_HISTORY_BASE_MALUS = 7;
int QUIET_HISTORY_FACTOR_MALUS = 202;
int QUIET_HISTORY_MAX_TT = 1264;
int QUIET_HISTORY_TT_FACTOR = 134;
int QUIET_HISTORY_TT_BASE = 71;

int CAPTURE_HISTORY_MALUS_MAX = 943;
int CAPTURE_HISTORY_BONUS_MAX = 1575;
int CAPTURE_HISTORY_BASE_BONUS = 11;
int CAPTURE_HISTORY_FACTOR_BONUS = 150;
int CAPTURE_HISTORY_BASE_MALUS = 10;
int CAPTURE_HISTORY_FACTOR_MALUS = 234;

int CONT_HISTORY_MALUS_MAX = 1364;
int CONT_HISTORY_BONUS_MAX = 2329;
int CONT_HISTORY_BASE_BONUS = 9;
int CONT_HISTORY_FACTOR_BONUS = 193;
int CONT_HISTORY_BASE_MALUS = 8;
int CONT_HISTORY_FACTOR_MALUS = 261;

int PAWN_HISTORY_MALUS_MAX = 1024;
int PAWN_HISTORY_BONUS_MAX = 1314;
int PAWN_HISTORY_BASE_BONUS = 9;
int PAWN_HISTORY_FACTOR_BONUS = 194;
