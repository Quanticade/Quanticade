...
int QUIET_HISTORY_MALUS_MAX = 1190;
int QUIET_HISTORY_BONUS_MAX = 1407;
int QUIET_HISTORY_BASE_BONUS = 10;
int QUIET_HISTORY_FACTOR_BONUS = 145;
int QUIET_HISTORY_BASE_MALUS = 8;
int QUIET_HISTORY_FACTOR_MALUS = 233;
int QUIET_HISTORY_MAX_TT = 1355;
int QUIET_HISTORY_TT_FACTOR = 131;
int QUIET_HISTORY_TT_BASE = 62;

int CAPTURE_HISTORY_MALUS_MAX = 1065;
int CAPTURE_HISTORY_BONUS_MAX = 1396;
int CAPTURE_HISTORY_BASE_BONUS = 10;
int CAPTURE_HISTORY_FACTOR_BONUS = 181;
int CAPTURE_HISTORY_BASE_MALUS = 12;
int CAPTURE_HISTORY_FACTOR_MALUS = 261;

int CONT_HISTORY_MALUS_MAX = 1326;
int CONT_HISTORY_BONUS_MAX = 1938;
int CONT_HISTORY_BASE_BONUS = 10;
int CONT_HISTORY_FACTOR_BONUS = 164;
int CONT_HISTORY_BASE_MALUS = 8;
int CONT_HISTORY_FACTOR_MALUS = 205;
int CONT_HISTORY_BASE2_BONUS = 11;
int CONT_HISTORY_FACTOR2_BONUS = 198;
int CONT_HISTORY_BASE2_MALUS = 10;
int CONT_HISTORY_FACTOR2_MALUS = 261;
int CONT_HISTORY_BASE4_BONUS = 10;
int CONT_HISTORY_FACTOR4_BONUS = 147;
int CONT_HISTORY_BASE4_MALUS = 9;
int CONT_HISTORY_FACTOR4_MALUS = 221;

int PAWN_HISTORY_MALUS_MAX = 1173;
int PAWN_HISTORY_BONUS_MAX = 1381;
int PAWN_HISTORY_BASE_BONUS = 10;
int PAWN_HISTORY_FACTOR_BONUS = 195;
int PAWN_HISTORY_BASE_MALUS = 9;
int PAWN_HISTORY_FACTOR_MALUS = 203;

int CORR_HISTORY_MINMAX = 313;
int PAWN_CORR_HISTORY_MULTIPLIER = 28;
int NON_PAWN_CORR_HISTORY_MULTIPLIER = 24;

int FIFTY_MOVE_SCALING = 191;
