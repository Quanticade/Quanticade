...
int CONT_HISTORY_BONUS_MAX = 1289;
int CAPTURE_HISTORY_MALUS_MAX = 1322;
int QUIET_HISTORY_MALUS_MAX = 1278;
int CONT_HISTORY_MALUS_MAX = 1231;
int CAPTURE_HISTORY_BONUS_MIN = 1303;
int QUIET_HISTORY_BONUS_MIN = 1267;
int CONT_HISTORY_BONUS_MIN = 1281;
int CAPTURE_HISTORY_MALUS_MIN = 1207;
int QUIET_HISTORY_MALUS_MIN = 1320;
int CONT_HISTORY_MALUS_MIN = 1311;
