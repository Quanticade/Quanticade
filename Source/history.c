...
TUNABLE(int CORR_HISTORY_MINMAX = 352);

TUNABLE(int PAWN_CORR_HISTORY_MULTIPLIER = 3247);
TUNABLE(int NON_PAWN_CORR_HISTORY_MULTIPLIER = 1837);

TUNABLE(int FIFTY_MOVE_SCALING = 214);
TUNABLE(int CORR_HISTORY_BONUS_SCALER = 130);
