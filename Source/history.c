...
int QUIET_HISTORY_MALUS_MAX = 2236;
int QUIET_HISTORY_BONUS_MAX = 2492;
int QUIET_HISTORY_BASE_BONUS = 22;
int QUIET_HISTORY_FACTOR_BONUS = 344;
int QUIET_HISTORY_BASE_MALUS = 16;
int QUIET_HISTORY_FACTOR_MALUS = 434;
int QUIET_HISTORY_MAX_TT = 2540;
int QUIET_HISTORY_TT_FACTOR = 266;
int QUIET_HISTORY_TT_BASE = 130;

int CAPTURE_HISTORY_MALUS_MAX = 2100;
int CAPTURE_HISTORY_BONUS_MAX = 2758;
int CAPTURE_HISTORY_BASE_BONUS = 20;
int CAPTURE_HISTORY_FACTOR_BONUS = 352;
int CAPTURE_HISTORY_BASE_MALUS = 22;
int CAPTURE_HISTORY_FACTOR_MALUS = 470;

int CONT_HISTORY_MALUS_MAX = 2616;
int CONT_HISTORY_BONUS_MAX = 4046;
int CONT_HISTORY_BASE_BONUS = 18;
int CONT_HISTORY_FACTOR_BONUS = 312;
int CONT_HISTORY_BASE_MALUS = 18;
int CONT_HISTORY_FACTOR_MALUS = 400;
int CONT_HISTORY_BASE2_BONUS = 20;
int CONT_HISTORY_FACTOR2_BONUS = 386;
int CONT_HISTORY_BASE2_MALUS = 20;
int CONT_HISTORY_FACTOR2_MALUS = 492;
int CONT_HISTORY_BASE4_BONUS = 18;
int CONT_HISTORY_FACTOR4_BONUS = 366;
int CONT_HISTORY_BASE4_MALUS = 18;
int CONT_HISTORY_FACTOR4_MALUS = 454;

int PAWN_HISTORY_MALUS_MAX = 2276;
int PAWN_HISTORY_BONUS_MAX = 2622;
int PAWN_HISTORY_BASE_BONUS = 18;
int PAWN_HISTORY_FACTOR_BONUS = 396;
int PAWN_HISTORY_BASE_MALUS = 20;
int PAWN_HISTORY_FACTOR_MALUS = 380;
