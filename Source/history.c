...
int QUIET_HISTORY_MALUS_MAX = 1160;
int QUIET_HISTORY_BONUS_MAX = 1143;
int QUIET_HISTORY_BASE_BONUS = 11;
int QUIET_HISTORY_FACTOR_BONUS = 173;
int QUIET_HISTORY_BASE_MALUS = 9;
int QUIET_HISTORY_FACTOR_MALUS = 220;

int CAPTURE_HISTORY_MALUS_MAX = 1061;
int CAPTURE_HISTORY_BONUS_MAX = 1304;
int CAPTURE_HISTORY_BASE_BONUS = 10;
int CAPTURE_HISTORY_FACTOR_BONUS = 192;
int CAPTURE_HISTORY_BASE_MALUS = 10;
int CAPTURE_HISTORY_FACTOR_MALUS = 221;

int CONT_HISTORY_MALUS_MAX = 1371;
int CONT_HISTORY_BONUS_MAX = 2043;
int CONT_HISTORY_BASE_BONUS = 9;
int CONT_HISTORY_FACTOR_BONUS = 176;
int CONT_HISTORY_BASE_MALUS = 10;
int CONT_HISTORY_FACTOR_MALUS = 197;
int CONT_HISTORY_BASE2_BONUS = 10;
int CONT_HISTORY_FACTOR2_BONUS = 199;
int CONT_HISTORY_BASE2_MALUS = 10;
int CONT_HISTORY_FACTOR2_MALUS = 234;
int CONT_HISTORY_BASE4_BONUS = 9;
int CONT_HISTORY_FACTOR4_BONUS = 176;
int CONT_HISTORY_BASE4_MALUS = 9;
int CONT_HISTORY_FACTOR4_MALUS = 206;

int PAWN_HISTORY_MALUS_MAX = 1113;
int PAWN_HISTORY_BONUS_MAX = 1356;
int PAWN_HISTORY_BASE_BONUS = 9;
int PAWN_HISTORY_FACTOR_BONUS = 186;
int PAWN_HISTORY_BASE_MALUS = 10;
int PAWN_HISTORY_FACTOR_MALUS = 221;
int CORR_HISTORY_MINMAX = 119;
int PAWN_CORR_HISTORY_MULTIPLIER = 27;
