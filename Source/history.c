...
int QUIET_HISTORY_MALUS_MAX = 1478;
int QUIET_HISTORY_BONUS_MAX = 627;
int QUIET_HISTORY_BASE_BONUS = 10;
int QUIET_HISTORY_FACTOR_BONUS = 239;
int QUIET_HISTORY_BASE_MALUS = 9;
int QUIET_HISTORY_FACTOR_MALUS = 317;
int QUIET_HISTORY_MAX_TT = 1324;
int QUIET_HISTORY_TT_FACTOR = 187;
int QUIET_HISTORY_TT_BASE = 48;

int CAPTURE_HISTORY_MALUS_MAX = 1067;
int CAPTURE_HISTORY_BONUS_MAX = 1797;
int CAPTURE_HISTORY_BASE_BONUS = 9;
int CAPTURE_HISTORY_FACTOR_BONUS = 123;
int CAPTURE_HISTORY_BASE_MALUS = 12;
int CAPTURE_HISTORY_FACTOR_MALUS = 240;

int CONT_HISTORY_MALUS_MAX = 1310;
int CONT_HISTORY_BONUS_MAX = 1508;
int CONT_HISTORY_BASE_BONUS = 11;
int CONT_HISTORY_FACTOR_BONUS = 134;
int CONT_HISTORY_BASE_MALUS = 10;
int CONT_HISTORY_FACTOR_MALUS = 218;

int PAWN_HISTORY_MALUS_MAX = 995;
int PAWN_HISTORY_BONUS_MAX = 1101;
int PAWN_HISTORY_BASE_BONUS = 8;
int PAWN_HISTORY_FACTOR_BONUS = 139;
int PAWN_HISTORY_BASE_MALUS = 12;
int PAWN_HISTORY_FACTOR_MALUS = 113;

int CORR_HISTORY_MINMAX = 263;
int PAWN_CORR_HISTORY_MULTIPLIER = 29;
int NON_PAWN_CORR_HISTORY_MULTIPLIER = 23;

int FIFTY_MOVE_SCALING = 197;
