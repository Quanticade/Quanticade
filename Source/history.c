...
TUNABLE(int CORR_HISTORY_MINMAX = 346);

TUNABLE(int PAWN_CORR_HISTORY_MULTIPLIER = 3026);
TUNABLE(int NON_PAWN_CORR_HISTORY_MULTIPLIER = 1770);

TUNABLE(int FIFTY_MOVE_SCALING = 198);
