...
double ASP_MULTIPLIER = 1.5376284462094907;
int LMR_QUIET_HIST_DIV = 6695;
int LMR_CAPT_HIST_DIV = 6495;
double LMR_OFFSET_QUIET = 0.8925073574365843;
double LMR_DIVISOR_QUIET = 1.621888864542387;
double LMR_OFFSET_NOISY = -0.29230867197506805;
double LMR_DIVISOR_NOISY = 3.2892222198528374;

int mvv[] = {108, 317, 307, 504, 1246, 0};

int SEEPieceValues[] = {92, 302, 289, 495, 1024, 0, 0};
