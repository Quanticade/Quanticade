...
// SPSA Tuned params
TUNABLE(int RAZOR_MARGIN = 316);
TUNABLE(int RFP_MARGIN = 58);
TUNABLE(int RFP_BASE_MARGIN = 25);
TUNABLE(int RFP_IMPROVING = 65);
TUNABLE(int RFP_OPP_WORSENING = 15);
TUNABLE(int FP_MULTIPLIER = 147);
TUNABLE(int FP_ADDITION = 171);
TUNABLE(int FP_HISTORY_DIVISOR = 29);
TUNABLE(int NMP_BASE_ADD = 235);
TUNABLE(int NMP_MULTIPLIER = 17);
TUNABLE(int NMP_BASE_REDUCTION = 1521);
TUNABLE(int NMP_DIVISER = 85);
TUNABLE(int SEE_QUIET_QUAD = 10);
TUNABLE(int SEE_QUIET_LINEAR = 10443);
TUNABLE(int SEE_QUIET_CONST = 284);
...
TUNABLE(int SE_BETA_DIVISOR = 64);
TUNABLE(int LDSE_MARGIN = 24);
TUNABLE(int LMR_PV_NODE = 901);
TUNABLE(int LMR_HISTORY_QUIET = 204);
TUNABLE(int LMR_HISTORY_NOISY = 155);
TUNABLE(int LMR_IN_CHECK = 976);
TUNABLE(int LMR_CUTNODE = 1654);
TUNABLE(int LMR_TT_DEPTH = 1174);
TUNABLE(int LMR_TT_PV = 1002);
TUNABLE(int LMR_TT_PV_CUTNODE = 911);
TUNABLE(int LMR_TT_SCORE = 849);
TUNABLE(int LMR_CUTOFF_CNT = 908);
TUNABLE(int LMR_IMPROVING = 983);
TUNABLE(int LMR_DEEPER_MARGIN = 39);
TUNABLE(int LMP_BETA_MARGIN = 15);
TUNABLE(int LMR_CORRECTION = 1870);
TUNABLE(int LMR_HASH_FLAG_EXACT = 978);
TUNABLE(int ASP_WINDOW = 15);
TUNABLE(int QS_FUTILITY_THRESHOLD = 88);
TUNABLE(int MO_SEE_THRESHOLD = 94);
TUNABLE(int LMP_HISTORY_DIVISOR = 7754);
TUNABLE(int ASP_WINDOW_DIVISER = 26769);
TUNABLE(int ASP_WINDOW_FAIL_LOW = 26);
TUNABLE(int ASP_WINDOW_FAIL_HIGH = 62);
TUNABLE(int HINDSIGH_REDUCTION_ADD = 2790);
TUNABLE(int HINDSIGH_REDUCTION_RED = 1835);
TUNABLE(int HINDSIGN_REDUCTION_EVAL_MARGIN = 86);
TUNABLE(int PROBCUT_MARGIN = 250);
TUNABLE(int MO_SEE_HISTORY_DIVISER = 29);
TUNABLE(int MO_QUIET_HIST_MULT = 951);
TUNABLE(int MO_CONT1_HIST_MULT = 1013);
TUNABLE(int MO_CONT2_HIST_MULT = 1010);
TUNABLE(int MO_CONT4_HIST_MULT = 1065);
TUNABLE(int MO_PAWN_HIST_MULT = 949);
TUNABLE(int MO_CAPT_HIST_MULT = 1245);
TUNABLE(int MO_MVV_MULT = 15035);
TUNABLE(int HISTORY_PRUNING_MARGIN = 2645);
TUNABLE(int BNFP_MARGIN = 146);

TUNABLE(int QUIET_HISTORY_MALUS_MAX = 1022);
TUNABLE(int QUIET_HISTORY_BONUS_MAX = 1213);
TUNABLE(int QUIET_HISTORY_BASE_BONUS = 11);
TUNABLE(int QUIET_HISTORY_FACTOR_BONUS = 167);
TUNABLE(int QUIET_HISTORY_BASE_MALUS = 7);
TUNABLE(int QUIET_HISTORY_FACTOR_MALUS = 279);
TUNABLE(int QUIET_HISTORY_MAX_TT = 1474);
TUNABLE(int QUIET_HISTORY_TT_FACTOR = 134);
TUNABLE(int QUIET_HISTORY_TT_BASE = 78);

TUNABLE(int CAPTURE_HISTORY_MALUS_MAX = 912);
TUNABLE(int CAPTURE_HISTORY_BONUS_MAX = 1558);
TUNABLE(int CAPTURE_HISTORY_BASE_BONUS = 9);
TUNABLE(int CAPTURE_HISTORY_FACTOR_BONUS = 135);
TUNABLE(int CAPTURE_HISTORY_BASE_MALUS = 10);
TUNABLE(int CAPTURE_HISTORY_FACTOR_MALUS = 272);
TUNABLE(int CAPTURE_HISTORY_QS_BONUS = 189);
TUNABLE(int CAPTURE_HISTORY_QS_MALUS = 266);

TUNABLE(int CONT_HISTORY_MALUS_MAX = 1280);
TUNABLE(int CONT_HISTORY_BONUS_MAX = 2527);
TUNABLE(int CONT_HISTORY_BASE_BONUS = 9);
TUNABLE(int CONT_HISTORY_FACTOR_BONUS = 183);
TUNABLE(int CONT_HISTORY_BASE_MALUS = 8);
TUNABLE(int CONT_HISTORY_FACTOR_MALUS = 224);

TUNABLE(int PAWN_HISTORY_MALUS_MAX = 843);
TUNABLE(int PAWN_HISTORY_BONUS_MAX = 1496);
TUNABLE(int PAWN_HISTORY_BASE_BONUS = 8);
TUNABLE(int PAWN_HISTORY_FACTOR_BONUS = 190);
TUNABLE(int PAWN_HISTORY_BASE_MALUS = 10);
TUNABLE(int PAWN_HISTORY_FACTOR_MALUS = 131);

TUNABLE(double LMP_MARGIN_WORSENING_BASE = 1.3409324230208168);
TUNABLE(double LMP_MARGIN_WORSENING_FACTOR = 0.400519614903753);
TUNABLE(double LMP_MARGIN_WORSENING_POWER = 1.646555042344621);
TUNABLE(double LMP_MARGIN_IMPROVING_BASE = 3.0611647999617544);
TUNABLE(double LMP_MARGIN_IMPROVING_FACTOR = 0.891496842132036);
TUNABLE(double LMP_MARGIN_IMPROVING_POWER = 1.8621092117546802);

TUNABLE(int LMR_OFFSET_QUIET = 713);
TUNABLE(int LMR_MULT_QUIET   = 515);
TUNABLE(int LMR_OFFSET_NOISY = -111);
TUNABLE(int LMR_MULT_NOISY   = 439);

TUNABLE(double NODE_TIME_MULTIPLIER = 2.407680811125708);
TUNABLE(double NODE_TIME_ADDITION = 0.4658108010964455);
TUNABLE(double NODE_TIME_MIN = 0.5509079188179025);

TUNABLE(double EVAL_TIME_ADDITION = 1.1953911868233449);
TUNABLE(double EVAL_TIME_MULTIPLIER = 0.05543468008133046);

TUNABLE(int SEEPieceValues[] = {63, 300, 343, 618, 1727, 0, 0});

TUNABLE(int mvv[] = {114, 340, 315, 487, 1477, 0});

int lmr[2][MAX_PLY + 1][256];
int lmp_margin[2][256];

TUNABLE(double bestmove_scale[5] = {2.3809103308937343, 1.3689156368969424, 1.1050680243591877, 0.8851193447943293, 0.7199264627423201});
