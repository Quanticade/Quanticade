...
// SPSA Tuned params
TUNABLE(int RAZOR_MARGIN = 307);
TUNABLE(int RFP_MARGIN = 61);
TUNABLE(int RFP_BASE_MARGIN = 25);
TUNABLE(int RFP_IMPROVING = 61);
TUNABLE(int RFP_OPP_WORSENING = 15);
TUNABLE(int FP_MULTIPLIER = 149);
TUNABLE(int FP_ADDITION = 169);
TUNABLE(int FP_HISTORY_DIVISOR = 27);
TUNABLE(int NMP_BASE_ADD = 231);
TUNABLE(int NMP_MULTIPLIER = 19);
TUNABLE(int NMP_BASE_REDUCTION = 1523);
TUNABLE(int NMP_DIVISER = 87);
TUNABLE(int SEE_QUIET_QUAD = 10);
TUNABLE(int SEE_QUIET_LINEAR = 10716);
TUNABLE(int SEE_QUIET_CONST = 312);
TUNABLE(int SEE_CAPTURE = 28);
TUNABLE(int SEE_QUIET_HISTORY_DIVISOR = 36);
TUNABLE(int SEE_NOISY_HISTORY_DIVISOR = 35);
TUNABLE(int SE_DOUBLE_MARGIN = 0);
TUNABLE(int SE_PV_DOUBLE_MARGIN = 155);
TUNABLE(int SE_TRIPLE_MARGIN = 39);
TUNABLE(int SE_PV_TRIPLE_MARGIN = 286);
TUNABLE(int SE_NOISY_TRIPLE_MARGIN = 198);
TUNABLE(int SE_BETA_BASE = 52);
TUNABLE(int SE_BETA_MULTIPLIER = 61);
TUNABLE(int SE_BETA_DIVISOR = 63);
TUNABLE(int LDSE_MARGIN = 26);
TUNABLE(int LMR_PV_NODE = 888);
TUNABLE(int LMR_HISTORY_QUIET = 1193);
TUNABLE(int LMR_HISTORY_NOISY = 1125);
TUNABLE(int LMR_WAS_IN_CHECK = 811);
TUNABLE(int LMR_IN_CHECK = 982);
TUNABLE(int LMR_CUTNODE = 1454);
TUNABLE(int LMR_TT_DEPTH = 1094);
TUNABLE(int LMR_TT_PV = 1119);
TUNABLE(int LMR_TT_PV_CUTNODE = 848);
TUNABLE(int LMR_TT_SCORE = 906);
TUNABLE(int LMR_CUTOFF_CNT = 913);
TUNABLE(int LMR_IMPROVING = 948);
TUNABLE(int LMR_DEEPER_MARGIN = 36);
TUNABLE(int LMR_SHALLOWER_MARGIN = 741);
TUNABLE(int LMP_BETA_MARGIN = 15);
TUNABLE(int LMR_CORRECTION = 1750);
TUNABLE(int LMR_HASH_FLAG_EXACT = 992);
TUNABLE(int ASP_WINDOW = 14);
TUNABLE(int QS_FUTILITY_THRESHOLD = 93);
TUNABLE(int MO_SEE_THRESHOLD = 96);
TUNABLE(int LMR_QUIET_HIST_DIV = 6506);
TUNABLE(int LMR_CAPT_HIST_DIV = 8660);
TUNABLE(int LMP_HISTORY_DIVISOR = 8267);
TUNABLE(int ASP_WINDOW_DIVISER = 29315);
TUNABLE(int ASP_WINDOW_FAIL_LOW = 28);
TUNABLE(int ASP_WINDOW_FAIL_HIGH = 58);
TUNABLE(int HINDSIGH_REDUCTION_ADD = 2980);
TUNABLE(int HINDSIGH_REDUCTION_RED = 2011);
TUNABLE(int HINDSIGN_REDUCTION_EVAL_MARGIN = 87);
TUNABLE(int PROBCUT_MARGIN = 251);
TUNABLE(int PROBCUT_SEE_THRESHOLD = 91);
TUNABLE(int MO_SEE_HISTORY_DIVISER = 32);
TUNABLE(int MO_QUIET_HIST_MULT = 965);
TUNABLE(int MO_CONT1_HIST_MULT = 1033);
TUNABLE(int MO_CONT2_HIST_MULT = 914);
TUNABLE(int MO_CONT4_HIST_MULT = 1044);
TUNABLE(int MO_PAWN_HIST_MULT = 886);
TUNABLE(int MO_CAPT_HIST_MULT = 1207);
TUNABLE(int MO_MVV_MULT = 14484);
TUNABLE(int MO_CHECK_SEE = 8549);
TUNABLE(int MO_QUIET_SEE = 100);
TUNABLE(int HISTORY_PRUNING_MARGIN = 2473);
TUNABLE(int BNFP_MARGIN = 148);

TUNABLE(int EVAL_STABILITY_VAR = 1177);
TUNABLE(int QS_SEE_THRESHOLD = 900);

TUNABLE(int QUIET_HISTORY_MALUS_MAX = 1004);
TUNABLE(int QUIET_HISTORY_BONUS_MAX = 1219);
TUNABLE(int QUIET_HISTORY_BASE_BONUS = 10);
TUNABLE(int QUIET_HISTORY_FACTOR_BONUS = 154);
TUNABLE(int QUIET_HISTORY_BASE_MALUS = 7);
TUNABLE(int QUIET_HISTORY_FACTOR_MALUS = 243);
TUNABLE(int QUIET_HISTORY_MAX_TT = 1446);
TUNABLE(int QUIET_HISTORY_TT_FACTOR = 128);
TUNABLE(int QUIET_HISTORY_TT_BASE = 78);

TUNABLE(int CAPTURE_HISTORY_MALUS_MAX = 910);
TUNABLE(int CAPTURE_HISTORY_BONUS_MAX = 1609);
TUNABLE(int CAPTURE_HISTORY_BASE_BONUS = 9);
TUNABLE(int CAPTURE_HISTORY_FACTOR_BONUS = 138);
TUNABLE(int CAPTURE_HISTORY_BASE_MALUS = 10);
TUNABLE(int CAPTURE_HISTORY_FACTOR_MALUS = 278);
TUNABLE(int CAPTURE_HISTORY_QS_BONUS = 169);
TUNABLE(int CAPTURE_HISTORY_QS_MALUS = 243);

TUNABLE(int CONT_HISTORY_MALUS_MAX = 1336);
TUNABLE(int CONT_HISTORY_BONUS_MAX = 2616);
TUNABLE(int CONT_HISTORY_BASE_BONUS = 9);
TUNABLE(int CONT_HISTORY_FACTOR_BONUS = 192);
TUNABLE(int CONT_HISTORY_BASE_MALUS = 8);
TUNABLE(int CONT_HISTORY_FACTOR_MALUS = 232);

TUNABLE(int PAWN_HISTORY_MALUS_MAX = 907);
TUNABLE(int PAWN_HISTORY_BONUS_MAX = 1452);
TUNABLE(int PAWN_HISTORY_BASE_BONUS = 9);
TUNABLE(int PAWN_HISTORY_FACTOR_BONUS = 192);
TUNABLE(int PAWN_HISTORY_BASE_MALUS = 10);
TUNABLE(int PAWN_HISTORY_FACTOR_MALUS = 143);

TUNABLE(double LMP_MARGIN_WORSENING_BASE = 1.3687594020063099);
TUNABLE(double LMP_MARGIN_WORSENING_FACTOR = 0.4171614954854807);
TUNABLE(double LMP_MARGIN_WORSENING_POWER = 1.6343757820431573);
TUNABLE(double LMP_MARGIN_IMPROVING_BASE = 2.990696011153048);
TUNABLE(double LMP_MARGIN_IMPROVING_FACTOR = 0.8860602661251242);
TUNABLE(double LMP_MARGIN_IMPROVING_POWER = 1.865750223867239);

TUNABLE(double LMR_OFFSET_QUIET = 0.7019677713421257);
TUNABLE(double LMR_DIVISOR_QUIET = 1.7958121141646208);
TUNABLE(double LMR_OFFSET_NOISY = -0.09880686224739696);
TUNABLE(double LMR_DIVISOR_NOISY = 2.3166100348079732);

TUNABLE(double NODE_TIME_MULTIPLIER = 2.4452461667238223);
TUNABLE(double NODE_TIME_ADDITION = 0.4663141476268559);
TUNABLE(double NODE_TIME_MIN = 0.5467976727569686);

TUNABLE(double EVAL_TIME_ADDITION = 1.1980574346272672);
TUNABLE(double EVAL_TIME_MULTIPLIER = 0.05945434696425842);

TUNABLE(int SEEPieceValues[] = {63, 337, 328, 611, 1593, 0, 0});

TUNABLE(int mvv[] = {117, 368, 327, 497, 1329, 0});

int lmr[2][MAX_PLY + 1][256];

TUNABLE(double bestmove_scale[5] = {2.4290829798013642, 1.366408388264618, 1.1069422607777553, 0.8883552216760534, 0.7162633163815404});
