...
const int SEEPieceValues[] = {103, 422, 437, 694, 1313, 0,
                              103, 422, 437, 694, 1313, 0};
...
int move_estimated_value(position_t *pos, int move) {
  ...
  int value = SEEPieceValues[pos->mailbox[get_move_source(move)]];

  // Factor in the new piece's value and remove our promoted pawn
  if (get_move_promoted(move))
    value += SEEPieceValues[get_move_promoted(move)] - SEEPieceValues[PAWN];
