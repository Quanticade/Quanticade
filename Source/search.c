...
double ASP_MULTIPLIER = 1.567723329173285;
int LMR_QUIET_HIST_DIV = 6018;
int LMR_CAPT_HIST_DIV = 6116;
double LMR_OFFSET_QUIET = 0.9295085052908123;
double LMR_DIVISOR_QUIET = 1.618477206184187;
double LMR_OFFSET_NOISY = -0.2707143566878083;
double LMR_DIVISOR_NOISY = 3.2665014652783304;

int mvv[] = {109, 292, 289, 498, 1320, 0};

int SEEPieceValues[] = {83, 307, 288, 508, 1200, 0, 0};
