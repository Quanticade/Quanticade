...
double ASP_MULTIPLIER = 1.543340116070103;
int LMR_QUIET_HIST_DIV = 6794;
int LMR_CAPT_HIST_DIV = 6538;
double LMR_OFFSET_QUIET = 0.911814945016736;
double LMR_DIVISOR_QUIET = 1.5987826416449933;
double LMR_OFFSET_NOISY = -0.2898468486451039;
double LMR_DIVISOR_NOISY = 3.367813054212223;

int mvv[] = {104, 316, 310, 507, 1274, 0};

int SEEPieceValues[] = {90, 302, 281, 513, 1066, 0, 0};
