...
int RFP_IMPROVING = 63;
int RFP_OPP_WORSENING = 15;
int FP_MULTIPLIER = 142;
int FP_ADDITION = 164;
int FP_HISTORY_DIVISOR = 29;
int NMP_BASE_ADD = 214;
int NMP_MULTIPLIER = 19;
int NMP_BASE_REDUCTION = 1625;
int NMP_DIVISER = 85;
int SEE_QUIET = 41;
int SEE_CAPTURE = 29;
int SEE_QUIET_HISTORY_DIVISOR = 35;
int SEE_NOISY_HISTORY_DIVISOR = 38;
int SE_DOUBLE_MARGIN = 1;
int SE_PV_DOUBLE_MARGIN = 2429;
int SE_NOISY_DOUBLE_MARGIN = 1;
int SE_TRIPLE_MARGIN = 623;
int SE_PV_TRIPLE_MARGIN = 4814;
int SE_NOISY_TRIPLE_MARGIN = 2388;
int SE_BETA_BASE = 57;
int SE_BETA_MULTIPLIER = 64;
int SE_BETA_DIVISOR = 58;
int LDSE_MARGIN = 25;
int LMR_PV_NODE = 900;
int LMR_HISTORY_QUIET = 1217;
int LMR_HISTORY_NOISY = 1144;
int LMR_WAS_IN_CHECK = 810;
int LMR_IN_CHECK = 959;
int LMR_CUTNODE = 1475;
int LMR_TT_DEPTH = 1056;
int LMR_TT_PV = 1071;
int LMR_TT_PV_CUTNODE = 849;
int LMR_TT_SCORE = 859;
int LMR_CUTOFF_CNT = 880;
int LMR_IMPROVING = 993;
int LMR_DEEPER_MARGIN = 35;
int LMP_BETA_MARGIN = 15;
int LMR_CORRECTION = 1857;
int LMR_HASH_FLAG_EXACT = 1019;
int ASP_WINDOW = 15;
int QS_FUTILITY_THRESHOLD = 96;
int MO_SEE_THRESHOLD = 96;
int LMR_QUIET_HIST_DIV = 6258;
int LMR_CAPT_HIST_DIV = 8455;
int LMP_HISTORY_DIVISOR = 8283;
int ASP_WINDOW_DIVISER = 29693;
int ASP_WINDOW_FAIL_LOW = 27;
int ASP_WINDOW_FAIL_HIGH = 59;
int HINDSIGH_REDUCTION_ADD = 3048;
int HINDSIGH_REDUCTION_RED = 1997;
int HINDSIGN_REDUCTION_EVAL_MARGIN = 86;
int PROBCUT_MARGIN = 249;
int PROBCUT_SEE_THRESHOLD = 98;
int MO_SEE_HISTORY_DIVISER = 31;
int MO_QUIET_HIST_MULT = 956;
int MO_CONT1_HIST_MULT = 1028;
int MO_CONT2_HIST_MULT = 918;
int MO_CONT4_HIST_MULT = 1041;
int MO_PAWN_HIST_MULT = 902;
int MO_CAPT_HIST_MULT = 1216;
int MO_MVV_MULT = 15084;
int MO_CHECK_SEE = 8432;
int MO_QUIET_SEE = 104;
int HISTORY_PRUNING_MARGIN = 2457;
int BNFP_MARGIN = 148;
int QUIET_HISTORY_MALUS_MAX = 1033;
int QUIET_HISTORY_BONUS_MAX = 1182;
int QUIET_HISTORY_BASE_BONUS = 10;
int QUIET_HISTORY_FACTOR_BONUS = 161;
int QUIET_HISTORY_BASE_MALUS = 7;
int QUIET_HISTORY_FACTOR_MALUS = 244;
int QUIET_HISTORY_MAX_TT = 1475;
int QUIET_HISTORY_TT_FACTOR = 126;
int QUIET_HISTORY_TT_BASE = 79;
int CAPTURE_HISTORY_MALUS_MAX = 912;
int CAPTURE_HISTORY_BONUS_MAX = 1560;
int CAPTURE_HISTORY_BASE_BONUS = 9;
int CAPTURE_HISTORY_FACTOR_BONUS = 137;
int CAPTURE_HISTORY_BASE_MALUS = 10;
int CAPTURE_HISTORY_FACTOR_MALUS = 264;
int CAPTURE_HISTORY_QS_BONUS = 171;
int CAPTURE_HISTORY_QS_MALUS = 244;
int CONT_HISTORY_MALUS_MAX = 1291;
int CONT_HISTORY_BONUS_MAX = 2489;
int CONT_HISTORY_BASE_BONUS = 9;
int CONT_HISTORY_FACTOR_BONUS = 182;
int CONT_HISTORY_BASE_MALUS = 8;
int CONT_HISTORY_FACTOR_MALUS = 229;
int PAWN_HISTORY_MALUS_MAX = 912;
int PAWN_HISTORY_BONUS_MAX = 1484;
int PAWN_HISTORY_BASE_BONUS = 9;
int PAWN_HISTORY_FACTOR_BONUS = 188;
int PAWN_HISTORY_BASE_MALUS = 10;
int PAWN_HISTORY_FACTOR_MALUS = 144;

double LMP_MARGIN_WORSENING_BASE = 1.4115537021381457;
double LMP_MARGIN_WORSENING_FACTOR = 0.418648683056171;
double LMP_MARGIN_WORSENING_POWER = 1.5918939749449164;
double LMP_MARGIN_IMPROVING_BASE = 2.9461393323223377;
double LMP_MARGIN_IMPROVING_FACTOR = 0.8849678872429368;
double LMP_MARGIN_IMPROVING_POWER = 1.8281829463293928;

double LMR_OFFSET_QUIET = 0.7219637774465012;
double LMR_DIVISOR_QUIET = 1.8287779554254882;
double LMR_OFFSET_NOISY = -0.1202058349822883;
double LMR_DIVISOR_NOISY = 2.4173061168252716;

double NODE_TIME_MULTIPLIER = 2.437962762883586;
double NODE_TIME_ADDITION = 0.46466275493390696;
double NODE_TIME_MIN = 0.5479955476094048;

double EVAL_TIME_ADDITION = 1.192095774946112;
double EVAL_TIME_MULTIPLIER = 0.05746724457655325;

int SEEPieceValues[] = {65, 327, 323, 631, 1602, 0, 0};

int mvv[] = {113, 357, 316, 479, 1306, 0};

int lmr[2][MAX_PLY + 1][256];

double bestmove_scale[5] = {2.434610379435367, 1.3642568083807847,
                            1.1023304992445448, 0.8829321197346855,
                            0.7133922905154598};
