...
// SPSA Tuned params
int RAZOR_MARGIN = 267;
int RFP_MARGIN = 63;
int RFP_BASE_MARGIN = 27;
int RFP_IMPROVING = 65;
int RFP_OPP_WORSENING = 14;
int FP_MULTIPLIER = 135;
int FP_ADDITION = 160;
int FP_HISTORY_DIVISOR = 29;
int NMP_RED_DIVISER = 144;
int NMP_BASE_ADD = 195;
...
int LMR_PV_NODE = 891;
int LMR_HISTORY_QUIET = 1216;
int LMR_HISTORY_NOISY = 1137;
int LMR_WAS_IN_CHECK = 849;
int LMR_IN_CHECK = 1088;
int LMR_CUTNODE = 1272;
int LMR_TT_DEPTH = 996;
int LMR_TT_PV = 997;
int LMR_TT_PV_CUTNODE = 882;
int LMR_TT_SCORE = 919;
int LMR_CUTOFF_CNT = 758;
int LMR_IMPROVING = 1011;
int LMR_DEEPER_MARGIN = 30;
int LMP_BETA_MARGIN = 15;
int ASP_WINDOW = 13;
int QS_FUTILITY_THRESHOLD = 93;
int MO_SEE_THRESHOLD = 122;
int LMR_QUIET_HIST_DIV = 5843;
int LMR_CAPT_HIST_DIV = 8125;
int ASP_WINDOW_DIVISER = 30696;
int ASP_WINDOW_MULTIPLIER = 448;
int HINDSIGH_REDUCTION_ADD = 2769;
int HINDSIGH_REDUCTION_RED = 2107;
int HINDSIGN_REDUCTION_EVAL_MARGIN = 93;
int PROBCUT_MARGIN = 202;
int PROBCUT_SEE_THRESHOLD = 100;
int MO_SEE_HISTORY_DIVISER = 33;
int MO_QUIET_HIST_MULT = 1111;
int MO_CONT1_HIST_MULT = 954;
int MO_CONT2_HIST_MULT = 976;
int MO_CONT4_HIST_MULT = 1105;
int MO_PAWN_HIST_MULT = 1026;
int MO_CAPT_HIST_MULT = 1010;
int MO_MVV_MULT = 961;
...
double LMR_DEEPER_MULT = 1.9649f;

double LMP_MARGIN_WORSENING_BASE = 1.5067958517150566f;
double LMP_MARGIN_WORSENING_FACTOR = 0.3704494126152002f;
double LMP_MARGIN_WORSENING_POWER = 1.6095986434240377f;
double LMP_MARGIN_IMPROVING_BASE = 2.899504811981501f;
double LMP_MARGIN_IMPROVING_FACTOR = 0.8713459197097735f;
double LMP_MARGIN_IMPROVING_POWER = 1.9555040980105198f;

double LMR_OFFSET_QUIET = 0.720790290602726f;
double LMR_DIVISOR_QUIET = 1.718653031067741f;
double LMR_OFFSET_NOISY = -0.13369724548390133f;
double LMR_DIVISOR_NOISY = 2.5845436341421135f;

double NODE_TIME_MULTIPLIER = 2.38099458718958f;
double NODE_TIME_ADDITION = 0.468991705585868f;
double NODE_TIME_MIN = 0.5542754444903858f;

double EVAL_TIME_ADDITION = 1.200402896380051f;
double EVAL_TIME_MULTIPLIER = 0.04953662724391663f;

int SEEPieceValues[] = {61, 318, 294, 517, 1420, 0, 0};

int mvv[] = {129, 345, 315, 500, 1451, 0};
...
double bestmove_scale[5] = {2.4150f, 1.3649f,
                            1.1005f, 0.8980f,
                            0.7142f};
