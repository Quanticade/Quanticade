...
int RFP_MARGIN = 62;
int RFP_BASE_MARGIN = 23;
int RFP_IMPROVING = 56;
int RFP_OPP_WORSENING = 11;
int FP_MULTIPLIER = 146;
int FP_ADDITION = 164;
int NMP_RED_DIVISER = 176;
int NMP_BASE_ADD = 166;
...
int LMR_PV_NODE = 971;
int LMR_HISTORY_QUIET = 1231;
int LMR_HISTORY_NOISY = 1140;
int LMR_IN_CHECK = 795;
int LMR_CUTNODE = 1039;
int LMR_TT_DEPTH = 1268;
int LMR_TT_PV = 977;
int LMR_TT_PV_CUTNODE = 754;
int LMR_TT_SCORE = 977;
...
int LMR_QUIET_HIST_DIV = 6369;
int LMR_CAPT_HIST_DIV = 7390;
int ASP_WINDOW_DIVISER = 33415;
int ASP_WINDOW_MULTIPLIER = 495;
int EVAL_STABILITY_VAR = 9;

double LMP_MARGIN_WORSENING_BASE = 1.5917247602948192f;
double LMP_MARGIN_WORSENING_FACTOR = 0.38843669919847196f;
double LMP_MARGIN_WORSENING_POWER = 1.6007226373214192f;
double LMP_MARGIN_IMPROVING_BASE = 2.845563990656693f;
double LMP_MARGIN_IMPROVING_FACTOR = 0.7988429416369175f;
double LMP_MARGIN_IMPROVING_POWER = 1.9142586103766304f;

double LMR_OFFSET_QUIET = 0.8056861670933736;
double LMR_DIVISOR_QUIET = 1.7356082524280374;
double LMR_OFFSET_NOISY = -0.14356752942366632;
double LMR_DIVISOR_NOISY = 2.739617868339485;
...
int SEEPieceValues[] = {61, 310, 335, 614, 1222, 0, 0};

int mvv[] = {133, 368, 300, 580, 1217, 0};
