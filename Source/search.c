...
int RAZOR_DEPTH = 7;
int RAZOR_MARGIN = 263;
int RFP_DEPTH = 7;
int RFP_MARGIN = 60;
int RFP_BASE_MARGIN = 25;
int RFP_IMPROVING = 58;
...
int NMP_DIVISER = 3;
int NMP_RED_DIVISER = 169;
int NMP_RED_MIN = 6;
int NMP_DEPTH = 3;
int NMP_BASE_ADD = 162;
...
int LMR_PV_NODE = 1032;
int LMR_HISTORY_QUIET = 1217;
int LMR_HISTORY_NOISY = 1170;
int LMR_IN_CHECK = 881;
int LMR_CUTNODE = 1009;
int LMR_TT_DEPTH = 1171;
int LMR_TT_PV = 944;
int LMR_TT_PV_CUTNODE = 735;
int LMR_TT_SCORE = 1004;
...
int MO_SEE_THRESHOLD = 111;
int LMR_QUIET_HIST_DIV = 6807;
int LMR_CAPT_HIST_DIV = 6688;
int ASP_WINDOW_DIVISER = 33265;
int ASP_WINDOW_MULTIPLIER = 501;
int EVAL_STABILITY_VAR = 10;

double LMP_MARGIN_WORSENING_BASE = 1.8231648131068825f;
double LMP_MARGIN_WORSENING_FACTOR = 0.3749719484617374f;
double LMP_MARGIN_WORSENING_POWER = 1.5627417094437033f;
double LMP_MARGIN_IMPROVING_BASE = 2.7468997550695997f;
double LMP_MARGIN_IMPROVING_FACTOR = 0.8080697478415312f;
double LMP_MARGIN_IMPROVING_POWER = 1.868109139320665f;

double LMR_OFFSET_QUIET = 0.8021005010976207;
double LMR_DIVISOR_QUIET = 1.6663481046618427;
double LMR_OFFSET_NOISY = -0.158390214825913;
double LMR_DIVISOR_NOISY = 3.0506078704851753;
...
int mvv[] = {132, 385, 294, 581, 1298, 0};

int SEEPieceValues[] = {73, 337, 330, 573, 1170, 0, 0};
