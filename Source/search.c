...
// SPSA Tuned params
TUNABLE(int RAZOR_MARGIN = 323);
TUNABLE(int RFP_MARGIN = 60);
TUNABLE(int RFP_BASE_MARGIN = 25);
TUNABLE(int RFP_IMPROVING = 65);
TUNABLE(int RFP_OPP_WORSENING = 15);
TUNABLE(int FP_MULTIPLIER = 150);
TUNABLE(int FP_ADDITION = 170);
TUNABLE(int FP_HISTORY_DIVISOR = 29);
TUNABLE(int NMP_BASE_ADD = 243);
TUNABLE(int NMP_MULTIPLIER = 18);
TUNABLE(int NMP_BASE_REDUCTION = 1496);
TUNABLE(int NMP_DIVISER = 85);
TUNABLE(int SEE_QUIET_QUAD = 9);
TUNABLE(int SEE_QUIET_LINEAR = 11062);
TUNABLE(int SEE_QUIET_CONST = 273);
TUNABLE(int SEE_CAPTURE = 26);
TUNABLE(int SEE_QUIET_HISTORY_DIVISOR = 37);
TUNABLE(int SEE_NOISY_HISTORY_DIVISOR = 38);
TUNABLE(int SE_TRIPLE_MARGIN = 37);
TUNABLE(int SE_BETA_BASE = 57);
TUNABLE(int SE_BETA_MULTIPLIER = 63);
TUNABLE(int SE_BETA_DIVISOR = 60);
TUNABLE(int LDSE_MARGIN = 25);
TUNABLE(int LMR_TT_SCORE = 477);
TUNABLE(int LMR_TT_DEPTH = 337);
TUNABLE(int LMR_HISTORY_QUIET = 196);
TUNABLE(int LMR_HISTORY_NOISY = 154);
TUNABLE(int LMR_PV_NODE = 512);
TUNABLE(int LMR_PV_NODE_MULTIPLIER = 443);
TUNABLE(int LMR_IN_CHECK = 1033);
TUNABLE(int LMR_TT_PV = 776);
TUNABLE(int LMR_TT_PV_SCORE = 534);
TUNABLE(int LMR_CUTNODE = 1581);
TUNABLE(int LMR_CUTNODE_NO_TT_MOVE = 2063);
TUNABLE(int LMR_CUTOFF_CNT = 1006);
...
TUNABLE(int LMP_HISTORY_DIVISOR = 7288);
TUNABLE(int ASP_WINDOW_DIVISER = 27893);
TUNABLE(int ASP_WINDOW_FAIL_LOW = 27);
TUNABLE(int ASP_WINDOW_FAIL_HIGH = 58);
TUNABLE(int HINDSIGH_REDUCTION_ADD = 2938);
TUNABLE(int HINDSIGH_REDUCTION_RED = 2062);
TUNABLE(int HINDSIGN_REDUCTION_EVAL_MARGIN = 88);
TUNABLE(int PROBCUT_MARGIN = 253);
TUNABLE(int PROBCUT_SEE_THRESHOLD = 100);
TUNABLE(int MO_SEE_HISTORY_DIVISER = 30);
TUNABLE(int MO_QUIET_HIST_MULT = 986);
TUNABLE(int MO_CONT1_HIST_MULT = 1025);
TUNABLE(int MO_CONT2_HIST_MULT = 982);
TUNABLE(int MO_CONT4_HIST_MULT = 996);
TUNABLE(int MO_PAWN_HIST_MULT = 943);
TUNABLE(int MO_CAPT_HIST_MULT = 1273);
TUNABLE(int MO_MVV_MULT = 14825);
TUNABLE(int MO_CHECK_SEE = 7939);
TUNABLE(int MO_QUIET_SEE = 96);
TUNABLE(int HISTORY_PRUNING_MARGIN = 2546);
TUNABLE(int BNFP_MARGIN = 150);

TUNABLE(int QUIET_HISTORY_MALUS_MAX = 1014);
TUNABLE(int QUIET_HISTORY_BONUS_MAX = 1158);
TUNABLE(int QUIET_HISTORY_BASE_BONUS = 10);
TUNABLE(int QUIET_HISTORY_FACTOR_BONUS = 166);
TUNABLE(int QUIET_HISTORY_BASE_MALUS = 7);
TUNABLE(int QUIET_HISTORY_FACTOR_MALUS = 269);
TUNABLE(int QUIET_HISTORY_MAX_TT = 1497);
TUNABLE(int QUIET_HISTORY_TT_FACTOR = 131);
TUNABLE(int QUIET_HISTORY_TT_BASE = 74);

TUNABLE(int CAPTURE_HISTORY_MALUS_MAX = 886);
TUNABLE(int CAPTURE_HISTORY_BONUS_MAX = 1590);
TUNABLE(int CAPTURE_HISTORY_BASE_BONUS = 9);
TUNABLE(int CAPTURE_HISTORY_FACTOR_BONUS = 136);
TUNABLE(int CAPTURE_HISTORY_BASE_MALUS = 10);
TUNABLE(int CAPTURE_HISTORY_FACTOR_MALUS = 263);
TUNABLE(int CAPTURE_HISTORY_QS_BONUS = 175);
TUNABLE(int CAPTURE_HISTORY_QS_MALUS = 260);

TUNABLE(int CONT_HISTORY_MALUS_MAX = 1342);
TUNABLE(int CONT_HISTORY_BONUS_MAX = 2433);
TUNABLE(int CONT_HISTORY_BASE_BONUS = 9);
TUNABLE(int CONT_HISTORY_FACTOR_BONUS = 192);
TUNABLE(int CONT_HISTORY_BASE_MALUS = 8);
TUNABLE(int CONT_HISTORY_FACTOR_MALUS = 221);

TUNABLE(int PAWN_HISTORY_MALUS_MAX = 886);
TUNABLE(int PAWN_HISTORY_BONUS_MAX = 1461);
TUNABLE(int PAWN_HISTORY_BASE_BONUS = 8);
TUNABLE(int PAWN_HISTORY_FACTOR_BONUS = 185);
TUNABLE(int PAWN_HISTORY_BASE_MALUS = 10);
TUNABLE(int PAWN_HISTORY_FACTOR_MALUS = 144);

TUNABLE(double LMP_MARGIN_WORSENING_BASE = 1.401244420274523);
TUNABLE(double LMP_MARGIN_WORSENING_FACTOR = 0.3962474700392179);
TUNABLE(double LMP_MARGIN_WORSENING_POWER = 1.659088270432199);
TUNABLE(double LMP_MARGIN_IMPROVING_BASE = 2.952008304146973);
TUNABLE(double LMP_MARGIN_IMPROVING_FACTOR = 0.8917265148827);
TUNABLE(double LMP_MARGIN_IMPROVING_POWER = 1.8710889646284232);

TUNABLE(int LMR_OFFSET_QUIET = 720);
TUNABLE(int LMR_MULT_QUIET   = 535);
TUNABLE(int LMR_OFFSET_NOISY = -110);
TUNABLE(int LMR_MULT_NOISY   = 424);

TUNABLE(double NODE_TIME_MULTIPLIER = 2.4352707233058433);
TUNABLE(double NODE_TIME_ADDITION = 0.4641865486518394);
TUNABLE(double NODE_TIME_MIN = 0.5464519307993261);

TUNABLE(double EVAL_TIME_ADDITION = 1.1909408544426667);
TUNABLE(double EVAL_TIME_MULTIPLIER = 0.05696560042442576);

TUNABLE(int SEEPieceValues[] = {68, 330, 315, 577, 1620, 0, 0});

TUNABLE(int mvv[] = {112, 372, 338, 470, 1466, 0});

int lmr[2][MAX_PLY + 1][256];

TUNABLE(double bestmove_scale[5] = {2.4059357579526033, 1.3703465024879091, 1.1019251125795968, 0.8868716458024544, 0.7167413682158568});
