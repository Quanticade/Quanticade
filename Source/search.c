...
// SPSA Tuned params
int RAZOR_MARGIN = 303;
int RFP_MARGIN = 61;
int RFP_BASE_MARGIN = 31;
int RFP_IMPROVING = 77;
int RFP_OPP_WORSENING = 15;
int FP_MULTIPLIER = 107;
int FP_ADDITION = 120;
int FP_HISTORY_DIVISOR = 31;
int NMP_RED_DIVISER = 161;
int NMP_BASE_ADD = 107;
int NMP_MULTIPLIER = 22;
int SEE_QUIET = 48;
int SEE_CAPTURE = 20;
int SEE_HISTORY_DIVISOR = 28;
int SE_PV_DOUBLE_MARGIN = 1;
int SE_DOUBLE_MARGIN = 2;
int SE_TRIPLE_MARGIN = 42;
int LMR_PV_NODE = 883;
int LMR_HISTORY_QUIET = 1052;
int LMR_HISTORY_NOISY = 1065;
int LMR_WAS_IN_CHECK = 805;
int LMR_IN_CHECK = 1177;
int LMR_CUTNODE = 1112;
int LMR_TT_DEPTH = 734;
int LMR_TT_PV = 1098;
int LMR_TT_PV_CUTNODE = 681;
int LMR_TT_SCORE = 885;
int LMR_CUTOFF_CNT = 847;
int LMR_IMPROVING = 945;
int LMR_DEEPER_MARGIN = 30;
int LMP_BETA_MARGIN = 15;
int ASP_WINDOW = 12;
int QS_FUTILITY_THRESHOLD = 108;
int MO_SEE_THRESHOLD = 118;
int LMR_QUIET_HIST_DIV = 3839;
int LMR_CAPT_HIST_DIV = 8572;
int ASP_WINDOW_DIVISER = 32673;
int ASP_WINDOW_MULTIPLIER = 429;
int HINDSIGH_REDUCTION_ADD = 1831;
int HINDSIGH_REDUCTION_RED = 2095;
int HINDSIGN_REDUCTION_EVAL_MARGIN = 73;
int PROBCUT_MARGIN = 222;
int PROBCUT_SEE_THRESHOLD = 105;
int MO_SEE_HISTORY_DIVISER = 23;
int MO_QUIET_HIST_MULT = 1085;
int MO_CONT1_HIST_MULT = 958;
int MO_CONT2_HIST_MULT = 974;
int MO_CONT4_HIST_MULT = 1062;
int MO_PAWN_HIST_MULT = 775;
int MO_CAPT_HIST_MULT = 1219;
int MO_MVV_MULT = 997;
double LMR_DEEPER_MULT = 2.0728f;

double LMP_MARGIN_WORSENING_BASE = 1.300786593387955f;
double LMP_MARGIN_WORSENING_FACTOR = 0.43021678240629785f;
double LMP_MARGIN_WORSENING_POWER = 1.7692189865663055f;
double LMP_MARGIN_IMPROVING_BASE = 2.727923079039544f;
double LMP_MARGIN_IMPROVING_FACTOR = 0.943145556223422f;
double LMP_MARGIN_IMPROVING_POWER = 2.121391942789533f;

double LMR_OFFSET_QUIET = 0.7273362244069204f;
double LMR_DIVISOR_QUIET = 1.5614880071673436f;
double LMR_OFFSET_NOISY = -0.14451198317758687f;
double LMR_DIVISOR_NOISY = 2.264580288818142f;
...
int SEEPieceValues[] = {68, 275, 274, 510, 1088, 0, 0};

int mvv[] = {124, 311, 327, 432, 1449, 0};
