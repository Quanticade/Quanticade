...
int RFP_MARGIN = 63;
int RFP_BASE_MARGIN = 24;
int RFP_IMPROVING = 57;
int RFP_OPP_WORSENING = 12;
int FP_MULTIPLIER = 146;
int FP_ADDITION = 161;
int FP_HISTORY_DIVISOR = 32;
int NMP_RED_DIVISER = 177;
int NMP_BASE_ADD = 167;
int NMP_MULTIPLIER = 22;
int IIR_DEPTH_REDUCTION = 3;
int SEE_QUIET = 48;
int SEE_CAPTURE = 30;
int SEE_HISTORY_DIVISOR = 46;
int SE_DEPTH_REDUCTION = 5;
int SE_PV_DOUBLE_MARGIN = 1;
int SE_TRIPLE_MARGIN = 36;
int LMR_PV_NODE = 949;
int LMR_HISTORY_QUIET = 1176;
int LMR_HISTORY_NOISY = 1125;
int LMR_WAS_IN_CHECK = 808;
int LMR_IN_CHECK = 1024;
int LMR_CUTNODE = 1070;
int LMR_TT_DEPTH = 1245;
int LMR_TT_PV = 968;
int LMR_TT_PV_CUTNODE = 763;
int LMR_TT_SCORE = 979;
int LMR_DEEPER_MARGIN = 35;
int LMR_SHALLOWER_MARGIN = 6;
int LMP_DEPTH_DIVISOR = 3;
int ASP_WINDOW = 13;
int QS_SEE_THRESHOLD = 7;
int MO_SEE_THRESHOLD = 116;
int LMR_QUIET_HIST_DIV = 6296;
int LMR_CAPT_HIST_DIV = 7489;
...
double LMP_MARGIN_WORSENING_POWER = 1.6008946573665757f;
double LMP_MARGIN_IMPROVING_BASE = 2.8582302357244878f;
double LMP_MARGIN_IMPROVING_FACTOR = 0.807201009599479f;
double LMP_MARGIN_IMPROVING_POWER = 1.9403752315539704f;

double LMR_OFFSET_QUIET = 0.7988326383840372f;
double LMR_DIVISOR_QUIET = 1.750021006545914f;
double LMR_OFFSET_NOISY = -0.1396558767554566f;
double LMR_DIVISOR_NOISY = 2.709103235049698f;

double NODE_TIME_MULTIPLIER = 2.3538260185251008f;
double NODE_TIME_ADDITION = 0.44624803495948784f;
double NODE_TIME_MIN = 0.5478630664917636f;

int SEEPieceValues[] = {61, 314, 332, 621, 1231, 0, 0};

int mvv[] = {132, 372, 298, 574, 1212, 0};
...
double bestmove_scale[5] = {2.4401073085252794f, 1.3606079861626896f,
                            1.0849603888641992f, 0.8817925837589523f,
                            0.7018987690746706f};
double eval_scale[5] = {1.243991273873914f, 1.134499803444893f,
                        0.9865509813003348f, 0.9476332242946202f,
                        0.8908114447005512f};
...
static inline int16_t negamax(position_t *pos, thread_t *thread,
  ...
  while (move_index < move_list->count) {
    ...
    if (!root_node && current_score > -MATE_SCORE) {
      // Late Move Pruning
      if (quiet &&
          moves_seen >=
              LMP_MARGIN[depth][improving || ss->static_eval >= beta] &&
          !only_pawns(pos)) {
        skip_quiets = 1;
      }
