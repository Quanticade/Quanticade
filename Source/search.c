...
// SPSA Tuned params
int RAZOR_MARGIN = 390;
int RFP_MARGIN = 85;
int RFP_BASE_MARGIN = 26;
int RFP_IMPROVING = 84;
int RFP_OPP_WORSENING = 20;
int FP_MULTIPLIER = 131;
int FP_ADDITION = 112;
int FP_HISTORY_DIVISOR = 41;
int NMP_RED_DIVISER = 152;
int NMP_BASE_ADD = 173;
int NMP_MULTIPLIER = 25;
int SEE_QUIET = 55;
int SEE_CAPTURE = 28;
int SEE_HISTORY_DIVISOR = 38;
int LMR_PV_NODE = 1011;
int LMR_HISTORY_QUIET = 669;
int LMR_HISTORY_NOISY = 1386;
int LMR_WAS_IN_CHECK = 755;
int LMR_IN_CHECK = 1259;
int LMR_CUTNODE = 1044;
int LMR_TT_DEPTH = 1597;
int LMR_TT_PV = 1136;
int LMR_TT_PV_CUTNODE = 852;
int LMR_TT_SCORE = 1221;
int LMR_CUTOFF_CNT = 996;
int LMR_IMPROVING = 584;
int LMR_DEEPER_MARGIN = 44;
int LMR_SHALLOWER_MARGIN = 10;
int ASP_WINDOW = 14;
int QS_SEE_THRESHOLD = 7;
int QS_FUTILITY_THRESHOLD = 125;
int MO_SEE_THRESHOLD = 160;
int LMR_QUIET_HIST_DIV = 6922;
int LMR_CAPT_HIST_DIV = 8521;
int ASP_WINDOW_DIVISER = 34560;
int ASP_WINDOW_MULTIPLIER = 546;
int HINDSIGH_REDUCTION_ADD = 2460;
int HINDSIGH_REDUCTION_RED = 2267;
int HINDSIGN_REDUCTION_EVAL_MARGIN = 61;
int PROBCUT_MARGIN = 178;
int PROBCUT_SEE_THRESHOLD = 103;
int MO_QUIET_HIST_MULT = 871;
int MO_CONT1_HIST_MULT = 1320;
int MO_CONT2_HIST_MULT = 882;
int MO_CONT4_HIST_MULT = 866;
int MO_PAWN_HIST_MULT = 1094;
int MO_CAPT_HIST_MULT = 537;
int MO_MVV_MULT = 565;
int SEARCH_QUIET_HIST_MULT = 1305;
int SEARCH_CONT1_HIST_MULT = 1397;
int SEARCH_CONT2_HIST_MULT = 1471;
int SEARCH_PAWN_HIST_MULT = 1365;
int SEARCH_CAPT_HIST_MULT = 600;
int SEARCH_MVV_MULT = 1408;
double LMR_DEEPER_MULT = 1.4603481333566186f;

double LMP_MARGIN_WORSENING_BASE = 1.5271373944357975f;
double LMP_MARGIN_WORSENING_FACTOR = 0.5136643485422401f;
double LMP_MARGIN_WORSENING_POWER = 1.6552339707616324f;
double LMP_MARGIN_IMPROVING_BASE = 3.196510889226404f;
double LMP_MARGIN_IMPROVING_FACTOR = 0.8574783678447112f;
double LMP_MARGIN_IMPROVING_POWER = 2.149540611252581f;

double LMR_OFFSET_QUIET = 0.883439578455176f;
double LMR_DIVISOR_QUIET = 1.5934265620144488f;
double LMR_OFFSET_NOISY = -0.2592732271030417f;
double LMR_DIVISOR_NOISY = 1.9750475855499625f;
...
int SEEPieceValues[] = {44, 313, 430, 666, 1229, 0, 0};

int mvv[] = {82, 526, 206, 502, 1749, 0};
