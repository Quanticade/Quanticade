...
int RAZOR_DEPTH = 6;
int RAZOR_MARGIN = 306;
int RFP_DEPTH = 7;
int RFP_MARGIN = 55;
int RFP_BONUS = 91;
int FP_DEPTH = 6;
int FP_MULTIPLIER = 155;
int FP_ADDITION = 122;
int NMP_BASE_REDUCTION = 4;
int NMP_DIVISER = 3;
int NMP_RED_DIVISER = 215;
int NMP_RED_MIN = 6;
int IIR_DEPTH = 5;
int SEE_QUIET = 44;
int SEE_CAPTURE = 31;
...
int MO_SEE_THRESHOLD = 114;
int CAPTURE_HISTORY_BONUS_MAX = 1036;
int QUIET_HISTORY_BONUS_MAX = 1241;
int CAPTURE_HISTORY_MALUS_MAX = 1388;
int QUIET_HISTORY_MALUS_MAX = 1094;
int HISTORY_MAX = 8192;
double ASP_MULTIPLIER = 1.5257684163638858;
int LMR_QUIET_HIST_DIV = 8294;
int LMR_CAPT_HIST_DIV = 6838;
double LMR_OFFSET_QUIET = 0.8778085226321926;
double LMR_DIVISOR_QUIET = 1.5972263057211882;
double LMR_OFFSET_NOISY = -0.23557369701406697;
double LMR_DIVISOR_NOISY = 2.833693544867636;
...
int SEEPieceValues[] = {96, 279, 269, 505, 1115, 0, 0};
