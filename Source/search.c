...
int SEE_QUIET = 46;
int SEE_CAPTURE = 29;
int SEE_HISTORY_DIVISOR = 86;
int SE_DEPTH_REDUCTION = 6;
int SE_PV_DOUBLE_MARGIN = 1;
int SE_TRIPLE_MARGIN = 36;
int LMR_PV_NODE = 888;
int LMR_HISTORY_QUIET = 2306;
int LMR_HISTORY_NOISY = 2052;
...
int LMR_QUIET_HIST_DIV = 12816;
int LMR_CAPT_HIST_DIV = 14584;
