...
int FP_ADDITION = 169;
int FP_HISTORY_DIVISOR = 28;
int NMP_RED_DIVISER = 140;
int NMP_BASE_ADD = 187;
...
int SE_TRIPLE_MARGIN = 38;
int LMR_PV_NODE = 882;
int LMR_HISTORY_QUIET = 1134;
int LMR_HISTORY_NOISY = 1077;
int LMR_WAS_IN_CHECK = 882;
int LMR_IN_CHECK = 1075;
int LMR_CUTNODE = 1293;
int LMR_TT_DEPTH = 1081;
int LMR_TT_PV = 1004;
int LMR_TT_PV_CUTNODE = 905;
int LMR_TT_SCORE = 871;
int LMR_CUTOFF_CNT = 832;
int LMR_IMPROVING = 927;
int LMR_DEEPER_MARGIN = 30;
int LMR_SHALLOWER_MARGIN = 6;
int LMP_BETA_MARGIN = 14;
int ASP_WINDOW = 12;
int QS_FUTILITY_THRESHOLD = 93;
int MO_SEE_THRESHOLD = 117;
int LMR_QUIET_HIST_DIV = 5917;
int LMR_CAPT_HIST_DIV = 8465;
int ASP_WINDOW_DIVISER = 32856;
int ASP_WINDOW_MULTIPLIER = 473;
int HINDSIGH_REDUCTION_ADD = 2775;
int HINDSIGH_REDUCTION_RED = 2126;
int HINDSIGN_REDUCTION_EVAL_MARGIN = 93;
int PROBCUT_MARGIN = 213;
int PROBCUT_SEE_THRESHOLD = 104;
int MO_SEE_HISTORY_DIVISER = 34;
int MO_QUIET_HIST_MULT = 1087;
int MO_CONT1_HIST_MULT = 913;
int MO_CONT2_HIST_MULT = 934;
int MO_CONT4_HIST_MULT = 1074;
int MO_PAWN_HIST_MULT = 993;
int MO_CAPT_HIST_MULT = 1098;
...
double LMR_DEEPER_MULT = 1.9368f;

double LMP_MARGIN_WORSENING_BASE = 1.4302f;
double LMP_MARGIN_WORSENING_FACTOR = 0.3817f;
double LMP_MARGIN_WORSENING_POWER = 1.3481f;
double LMP_MARGIN_IMPROVING_BASE = 2.8096f;
double LMP_MARGIN_IMPROVING_FACTOR = 0.8511f;
double LMP_MARGIN_IMPROVING_POWER = 1.9243f;

double LMR_OFFSET_QUIET = 0.7242f;
double LMR_DIVISOR_QUIET = 1.7338f;
double LMR_OFFSET_NOISY = -0.1225f;
double LMR_DIVISOR_NOISY = 2.4889f;

double NODE_TIME_MULTIPLIER = 2.4139f;
double NODE_TIME_ADDITION = 0.4579f;
double NODE_TIME_MIN = 0.5463f;

double EVAL_TIME_ADDITION = 1.2044f;
double EVAL_TIME_MULTIPLIER = 0.04241f;

int SEEPieceValues[] = {62, 297, 301, 557, 1411, 0, 0};

int mvv[] = {127, 357, 319, 512, 1286, 0};
...
double bestmove_scale[5] = {2.4219f, 1.3650f, 1.1099f, 0.9002f, 0.7071f};
