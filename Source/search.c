...
// SPSA Tuned params
int RAZOR_MARGIN = 268;
int RFP_MARGIN = 53;
int RFP_BASE_MARGIN = 24;
int RFP_IMPROVING = 53;
int RFP_OPP_WORSENING = 13;
int FP_MULTIPLIER = 128;
int FP_ADDITION = 129;
int FP_HISTORY_DIVISOR = 29;
int NMP_RED_DIVISER = 173;
int NMP_BASE_ADD = 163;
int NMP_MULTIPLIER = 21;
int IIR_DEPTH_REDUCTION = 3;
int SEE_QUIET = 42;
int SEE_CAPTURE = 27;
int SEE_HISTORY_DIVISOR = 44;
int SE_DEPTH_REDUCTION = 5;
int SE_PV_DOUBLE_MARGIN = 1;
int SE_TRIPLE_MARGIN = 36;
int LMR_PV_NODE = 928;
int LMR_HISTORY_QUIET = 1152;
int LMR_HISTORY_NOISY = 1096;
int LMR_WAS_IN_CHECK = 886;
int LMR_IN_CHECK = 1053;
int LMR_CUTNODE = 1102;
int LMR_TT_DEPTH = 1157;
int LMR_TT_PV = 1149;
int LMR_TT_PV_CUTNODE = 764;
int LMR_TT_SCORE = 905;
int LMR_CUTOFF_CNT = 1031;
int LMR_IMPROVING = 923;
int LMR_DEEPER_MARGIN = 36;
int LMR_SHALLOWER_MARGIN = 6;
int LMP_DEPTH_DIVISOR = 3;
int ASP_WINDOW = 14;
int QS_SEE_THRESHOLD = 7;
int QS_FUTILITY_THRESHOLD = 107;
int MO_SEE_THRESHOLD = 117;
int LMR_QUIET_HIST_DIV = 6341;
int LMR_CAPT_HIST_DIV = 6903;
int ASP_WINDOW_DIVISER = 25707;
int ASP_WIN_RED_BASE = 37;
int ASP_WIN_RED_MULT = 16;
int EVAL_STABILITY_VAR = 9;
int HINDSIGH_REDUCTION_ADD = 3131;
int HINDSIGH_REDUCTION_RED = 1667;
int HINDSIGN_REDUCTION_EVAL_MARGIN = 85;
double LMR_DEEPER_MULT = 1.9864249322588734f;

double LMP_MARGIN_WORSENING_BASE = 1.3983852213301606f;
double LMP_MARGIN_WORSENING_FACTOR = 0.4229417279195544f;
double LMP_MARGIN_WORSENING_POWER = 1.7057072099567188f;
double LMP_MARGIN_IMPROVING_BASE = 3.0008373024612864f;
double LMP_MARGIN_IMPROVING_FACTOR = 0.8671190646574866f;
double LMP_MARGIN_IMPROVING_POWER = 2.229691396665084f;

double LMR_OFFSET_QUIET = 0.8325677513402298f;
double LMR_DIVISOR_QUIET = 1.8424751972767592f;
double LMR_OFFSET_NOISY = -0.1376277810441474f;
double LMR_DIVISOR_NOISY = 2.5856061973492683f;
...
int SEEPieceValues[] = {59, 299, 286, 589, 1286, 0, 0};

int mvv[] = {125, 379, 280, 605, 1335, 0};
