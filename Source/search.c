...
int FP_MULTIPLIER = 174;
int FP_ADDITION = 163;
int NMP_RED_DIVISER = 167;
int NMP_BASE_ADD = 155;
...
int LMR_PV_NODE = 1039;
int LMR_HISTORY_QUIET = 1204;
int LMR_HISTORY_NOISY = 1164;
int LMR_IN_CHECK = 891;
int LMR_CUTNODE = 1013;
int LMR_TT_DEPTH = 1163;
int LMR_TT_PV = 965;
int LMR_TT_PV_CUTNODE = 736;
int LMR_TT_SCORE = 995;
...
int ASP_WINDOW_DIVISER = 32957;
int ASP_WINDOW_MULTIPLIER = 493;
int EVAL_STABILITY_VAR = 9;

double LMP_MARGIN_WORSENING_BASE = 1.8064625755845731f;
double LMP_MARGIN_WORSENING_FACTOR = 0.3779801379613734f;
double LMP_MARGIN_WORSENING_POWER = 1.5654781245772438f;
double LMP_MARGIN_IMPROVING_BASE = 2.745858066071685f;
double LMP_MARGIN_IMPROVING_FACTOR = 0.7989910198478869f;
double LMP_MARGIN_IMPROVING_POWER = 1.8664296790166799f;

double LMR_OFFSET_QUIET = 0.8125832273799232;
double LMR_DIVISOR_QUIET = 1.6996701194748898;
double LMR_OFFSET_NOISY = -0.15484342910464047;
double LMR_DIVISOR_NOISY = 3.048685376295147;
...
int SEEPieceValues[] = {72, 332, 331, 579, 1166, 0, 0};

int mvv[] = {134, 377, 288, 586, 1284, 0};
...
static inline int16_t negamax(position_t *pos, thread_t *thread,
  ...
  while (move_index < move_list->count) {
    ...
    if (depth >= 3 && moves_seen > 2 + 2 * root_node &&
        (!get_move_capture(move) || !ss->tt_pv || cutnode)) {
      ss->reduction = R;
