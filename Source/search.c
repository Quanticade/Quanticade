...
int RAZOR_DEPTH = 7;
int RAZOR_MARGIN = 301;
int RFP_DEPTH = 7;
int RFP_MARGIN = 55;
int RFP_BONUS = 91;
int FP_DEPTH = 6;
int FP_MULTIPLIER = 151;
int FP_ADDITION = 124;
int NMP_BASE_REDUCTION = 4;
int NMP_DIVISER = 3;
int NMP_RED_DIVISER = 217;
int NMP_RED_MIN = 6;
int IIR_DEPTH = 5;
int SEE_QUIET = 44;
int SEE_CAPTURE = 31;
...
int CAPTURE_HISTORY_BONUS_MAX = 1032;
int QUIET_HISTORY_BONUS_MAX = 1226;
int CAPTURE_HISTORY_MALUS_MAX = 1384;
int QUIET_HISTORY_MALUS_MAX = 1104;
int HISTORY_MAX = 8192;
double ASP_MULTIPLIER = 1.5334504741595867;
int LMR_QUIET_HIST_DIV = 8472;
int LMR_CAPT_HIST_DIV = 6912;
double LMR_OFFSET_QUIET = 0.8643462110249359;
double LMR_DIVISOR_QUIET = 1.5993828782589141;
double LMR_OFFSET_NOISY = -0.23773070380402103;
double LMR_DIVISOR_NOISY = 2.849451335688153;
...
int SEEPieceValues[] = {97, 279, 274, 504, 1112, 0, 0};
