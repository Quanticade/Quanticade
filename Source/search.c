...
int RAZOR_DEPTH = 7;
int RAZOR_MARGIN = 297;
int RFP_DEPTH = 7;
int RFP_MARGIN = 56;
int RFP_BONUS = 94;
int FP_DEPTH = 5;
int FP_MULTIPLIER = 163;
int FP_ADDITION = 128;
int NMP_BASE_REDUCTION = 4;
int NMP_DIVISER = 3;
int NMP_RED_DIVISER = 222;
int NMP_RED_MIN = 6;
int IIR_DEPTH = 4;
int SEE_QUIET = 49;
int SEE_CAPTURE = 34;
...
int CAPTURE_HISTORY_BONUS_MAX = 1153;
int QUIET_HISTORY_BONUS_MAX = 1212;
int CAPTURE_HISTORY_MALUS_MAX = 1379;
int QUIET_HISTORY_MALUS_MAX = 1177;
int HISTORY_MAX = 8192;
double ASP_MULTIPLIER = 1.5422242100509405;
int LMR_QUIET_HIST_DIV = 7721;
int LMR_CAPT_HIST_DIV = 7270;
double LMR_OFFSET_QUIET = 0.8550012605725285;
double LMR_DIVISOR_QUIET = 1.6286075825429487;
double LMR_OFFSET_NOISY = -0.25550708049119225;
double LMR_DIVISOR_NOISY = 3.0041634260592445;
...
int SEEPieceValues[] = {99, 271, 275, 497, 1072, 0, 0};
