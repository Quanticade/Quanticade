...
int RFP_BONUS = 94;
int FP_DEPTH = 6;
int FP_MULTIPLIER = 164;
int FP_ADDITION = 126;
int NMP_BASE_REDUCTION = 4;
int NMP_DIVISER = 3;
int NMP_RED_DIVISER = 221;
int NMP_RED_MIN = 6;
int IIR_DEPTH = 4;
int SEE_QUIET = 45;
int SEE_CAPTURE = 34;
...
int MO_SEE_THRESHOLD = 120;
int CAPTURE_HISTORY_BONUS_MAX = 1201;
int QUIET_HISTORY_BONUS_MAX = 1206;
int CAPTURE_HISTORY_MALUS_MAX = 1429;
int QUIET_HISTORY_MALUS_MAX = 1130;
int HISTORY_MAX = 8192;
double ASP_MULTIPLIER = 1.5442278834799703;
int LMR_QUIET_HIST_DIV = 7998;
int LMR_CAPT_HIST_DIV = 7228;
double LMR_OFFSET_QUIET = 0.8205951967042058;
double LMR_DIVISOR_QUIET = 1.650332215288241;
double LMR_OFFSET_NOISY = -0.24747988745479932;
double LMR_DIVISOR_NOISY = 2.789006362809655;
...
int SEEPieceValues[] = {98, 262, 277, 478, 1094, 0, 0};
