...
// SPSA Tuned params
TUNABLE(int RAZOR_MARGIN = 319);
TUNABLE(int RFP_MARGIN = 57);
TUNABLE(int RFP_BASE_MARGIN = 25);
TUNABLE(int RFP_IMPROVING = 67);
TUNABLE(int RFP_OPP_WORSENING = 15);
TUNABLE(int FP_MULTIPLIER = 143);
TUNABLE(int FP_ADDITION = 161);
TUNABLE(int FP_HISTORY_DIVISOR = 28);
TUNABLE(int NMP_BASE_ADD = 234);
TUNABLE(int NMP_MULTIPLIER = 17);
TUNABLE(int NMP_BASE_REDUCTION = 1452);
TUNABLE(int NMP_DIVISER = 85);
TUNABLE(int SEE_QUIET_QUAD = 10);
TUNABLE(int SEE_QUIET_LINEAR = 9821);
TUNABLE(int SEE_QUIET_CONST = 289);
TUNABLE(int SEE_CAPTURE = 26);
TUNABLE(int SEE_QUIET_HISTORY_DIVISOR = 34);
TUNABLE(int SEE_NOISY_HISTORY_DIVISOR = 36);
TUNABLE(int SE_TRIPLE_MARGIN = 38);
TUNABLE(int SE_BETA_BASE = 58);
TUNABLE(int SE_BETA_MULTIPLIER = 57);
TUNABLE(int SE_BETA_DIVISOR = 68);
TUNABLE(int LDSE_MARGIN = 25);
TUNABLE(int LMR_PV_NODE = 907);
TUNABLE(int LMR_HISTORY_QUIET = 191);
TUNABLE(int LMR_HISTORY_NOISY = 156);
TUNABLE(int LMR_IN_CHECK = 992);
TUNABLE(int LMR_CUTNODE = 1733);
TUNABLE(int LMR_TT_DEPTH = 1144);
TUNABLE(int LMR_TT_PV = 972);
TUNABLE(int LMR_TT_PV_CUTNODE = 903);
TUNABLE(int LMR_TT_SCORE = 886);
TUNABLE(int LMR_CUTOFF_CNT = 880);
TUNABLE(int LMR_IMPROVING = 976);
TUNABLE(int LMR_DEEPER_MARGIN = 36);
TUNABLE(int LMP_BETA_MARGIN = 13);
TUNABLE(int LMR_CORRECTION = 1945);
TUNABLE(int LMR_HASH_FLAG_EXACT = 970);
TUNABLE(int ASP_WINDOW = 16);
TUNABLE(int QS_FUTILITY_THRESHOLD = 90);
TUNABLE(int MO_SEE_THRESHOLD = 95);
TUNABLE(int LMP_HISTORY_DIVISOR = 7610);
TUNABLE(int ASP_WINDOW_DIVISER = 26679);
TUNABLE(int ASP_WINDOW_FAIL_LOW = 26);
TUNABLE(int ASP_WINDOW_FAIL_HIGH = 62);
TUNABLE(int HINDSIGH_REDUCTION_ADD = 2800);
TUNABLE(int HINDSIGH_REDUCTION_RED = 1817);
TUNABLE(int HINDSIGN_REDUCTION_EVAL_MARGIN = 85);
TUNABLE(int PROBCUT_MARGIN = 245);
TUNABLE(int MO_SEE_HISTORY_DIVISER = 28);
TUNABLE(int MO_QUIET_HIST_MULT = 928);
TUNABLE(int MO_CONT1_HIST_MULT = 1010);
TUNABLE(int MO_CONT2_HIST_MULT = 1029);
TUNABLE(int MO_CONT4_HIST_MULT = 1088);
TUNABLE(int MO_PAWN_HIST_MULT = 969);
TUNABLE(int MO_CAPT_HIST_MULT = 1331);
TUNABLE(int MO_MVV_MULT = 15780);
TUNABLE(int HISTORY_PRUNING_MARGIN = 2666);
TUNABLE(int BNFP_MARGIN = 144);
TUNABLE(int BNFP_HISTORY_DIVIDER = 30);

TUNABLE(int QUIET_HISTORY_MALUS_MAX = 1006);
TUNABLE(int QUIET_HISTORY_BONUS_MAX = 1204);
TUNABLE(int QUIET_HISTORY_BASE_BONUS = 11);
TUNABLE(int QUIET_HISTORY_FACTOR_BONUS = 166);
TUNABLE(int QUIET_HISTORY_BASE_MALUS = 7);
TUNABLE(int QUIET_HISTORY_FACTOR_MALUS = 290);
TUNABLE(int QUIET_HISTORY_MAX_TT = 1475);
TUNABLE(int QUIET_HISTORY_TT_FACTOR = 135);
TUNABLE(int QUIET_HISTORY_TT_BASE = 78);

TUNABLE(int CAPTURE_HISTORY_MALUS_MAX = 946);
TUNABLE(int CAPTURE_HISTORY_BONUS_MAX = 1607);
TUNABLE(int CAPTURE_HISTORY_BASE_BONUS = 10);
TUNABLE(int CAPTURE_HISTORY_FACTOR_BONUS = 139);
TUNABLE(int CAPTURE_HISTORY_BASE_MALUS = 10);
TUNABLE(int CAPTURE_HISTORY_FACTOR_MALUS = 287);
TUNABLE(int CAPTURE_HISTORY_QS_BONUS = 184);
TUNABLE(int CAPTURE_HISTORY_QS_MALUS = 266);

TUNABLE(int CONT_HISTORY_MALUS_MAX = 1303);
TUNABLE(int CONT_HISTORY_BONUS_MAX = 2614);
TUNABLE(int CONT_HISTORY_BASE_BONUS = 9);
TUNABLE(int CONT_HISTORY_FACTOR_BONUS = 192);
TUNABLE(int CONT_HISTORY_BASE_MALUS = 9);
TUNABLE(int CONT_HISTORY_FACTOR_MALUS = 228);

TUNABLE(int PAWN_HISTORY_MALUS_MAX = 805);
TUNABLE(int PAWN_HISTORY_BONUS_MAX = 1497);
TUNABLE(int PAWN_HISTORY_BASE_BONUS = 8);
TUNABLE(int PAWN_HISTORY_FACTOR_BONUS = 176);
TUNABLE(int PAWN_HISTORY_BASE_MALUS = 11);
TUNABLE(int PAWN_HISTORY_FACTOR_MALUS = 134);

TUNABLE(double LMP_MARGIN_WORSENING_BASE = 1.333476945076587);
TUNABLE(double LMP_MARGIN_WORSENING_FACTOR = 0.42554840846259434);
TUNABLE(double LMP_MARGIN_WORSENING_POWER = 1.7037454972441513);
TUNABLE(double LMP_MARGIN_IMPROVING_BASE = 3.0265873290922167);
TUNABLE(double LMP_MARGIN_IMPROVING_FACTOR = 0.9173190394849218);
TUNABLE(double LMP_MARGIN_IMPROVING_POWER = 1.8847908245375669);

TUNABLE(int LMR_OFFSET_QUIET = 663);
TUNABLE(int LMR_MULT_QUIET   = 504);
TUNABLE(int LMR_OFFSET_NOISY = -113);
TUNABLE(int LMR_MULT_NOISY   = 421);

TUNABLE(double NODE_TIME_MULTIPLIER = 2.416603128452088);
TUNABLE(double NODE_TIME_ADDITION = 0.4702787176119841);
TUNABLE(double NODE_TIME_MIN = 0.5468670320999616);

TUNABLE(double EVAL_TIME_ADDITION = 1.1964029106615721);
TUNABLE(double EVAL_TIME_MULTIPLIER = 0.05768270689313057);

TUNABLE(int SEEPieceValues[] = {58, 312, 346, 631, 1688, 0, 0});

TUNABLE(int mvv[] = {109, 335, 338, 484, 1407, 0});

int lmr[2][MAX_PLY + 1][256];
int lmp_margin[2][256];

TUNABLE(double bestmove_scale[5] = {2.396175308306762, 1.3690006019841876, 1.1035978292462212, 0.8857711329456905, 0.7218438624950849});
...
static inline int16_t negamax(thread_t *thread, searchstack_t *ss,
  ...
  while ((move = select_next(&picker)) != 0) {
    ...
    if (depth >= 2 && moves_seen > 1 + root_node) {
      ...
      R -= ss->history_score *
           (quiet ? LMR_HISTORY_QUIET : LMR_HISTORY_NOISY) / 1024;
