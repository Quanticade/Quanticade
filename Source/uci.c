...
TUNABLE(double DEF_TIME_MULTIPLIER = 0.09159917600880663);
TUNABLE(double DEF_INC_MULTIPLIER = 0.8493453495576672);
TUNABLE(double MAX_TIME_MULTIPLIER = 0.7482310095530085);
TUNABLE(double SOFT_LIMIT_MULTIPLIER = 0.8005263983355074);
