...
double DEF_TIME_MULTIPLIER = 0.0830156746886356;
double DEF_INC_MULTIPLIER = 0.8457602805164491;
double MAX_TIME_MULTIPLIER = 0.7522236059887565;
double SOFT_LIMIT_MULTIPLIER = 0.7896376096976858;
