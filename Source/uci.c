...
TUNABLE(double DEF_TIME_MULTIPLIER = 0.092911393956623);
TUNABLE(double DEF_INC_MULTIPLIER = 0.847840809382933);
TUNABLE(double MAX_TIME_MULTIPLIER = 0.7502869387797103);
TUNABLE(double SOFT_LIMIT_MULTIPLIER = 0.8090826823712126);
