...
double DEF_TIME_MULTIPLIER = 0.0885399403157702;
double DEF_INC_MULTIPLIER = 0.8375160622106945;
double MAX_TIME_MULTIPLIER = 0.7457532908716603;
double HARD_LIMIT_MULTIPLIER = 3.0814665562713093;
double SOFT_LIMIT_MULTIPLIER = 0.7691954986263952;
