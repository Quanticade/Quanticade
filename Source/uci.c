...
double DEF_TIME_MULTIPLIER = 0.09165419697202717f;
double DEF_INC_MULTIPLIER = 0.8410064080854901f;
double MAX_TIME_MULTIPLIER = 0.7468385044848566f;
double SOFT_LIMIT_MULTIPLIER = 0.7738359594137587f;
