...
double DEF_TIME_MULTIPLIER = 0.0723798443294602;
double DEF_INC_MULTIPLIER = 0.8515997566476585;
double MAX_TIME_MULTIPLIER = 0.7671042758056495;
double HARD_LIMIT_MULTIPLIER = 3.0098975394497263;
double SOFT_LIMIT_MULTIPLIER = 0.7688615581604402;
