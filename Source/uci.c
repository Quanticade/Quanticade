...
TUNABLE(double DEF_TIME_MULTIPLIER = 0.09847661185668657);
TUNABLE(double DEF_INC_MULTIPLIER = 0.850270448436556);
TUNABLE(double MAX_TIME_MULTIPLIER = 0.7478680094792053);
TUNABLE(double SOFT_LIMIT_MULTIPLIER = 0.8057581286750003);
