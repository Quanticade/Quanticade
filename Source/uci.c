...
double DEF_TIME_MULTIPLIER =  0.07518318179349268;
double DEF_INC_MULTIPLIER = 0.8484238334250974;
double MAX_TIME_MULTIPLIER = 0.7615963154150045;
double HARD_LIMIT_MULTIPLIER = 3.0338057740214346;
double SOFT_LIMIT_MULTIPLIER = 0.7815228177806117;
