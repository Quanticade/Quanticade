...
double DEF_TIME_MULTIPLIER = 0.07731384149480736f;
double DEF_INC_MULTIPLIER = 0.84931142537823f;
double MAX_TIME_MULTIPLIER = 0.7398415153795106f;
double SOFT_LIMIT_MULTIPLIER = 0.7709454531974527f;
