...
double DEF_TIME_MULTIPLIER = 0.08731326704044093;
double DEF_INC_MULTIPLIER = 0.8429133751208786;
double MAX_TIME_MULTIPLIER = 0.7408544257173533;
double HARD_LIMIT_MULTIPLIER = 3.0756968836836713;
double SOFT_LIMIT_MULTIPLIER = 0.7727356857335939;
  ...
  while (1) {
    ...
    // parse UCI "ucinewgame" command
      ...
      for (int i = 0; i < thread_count; ++i) {
        ...
        memset(threads[i].non_pawn_correction_history, 0,
               sizeof(threads[i].non_pawn_correction_history));
      }
    }
