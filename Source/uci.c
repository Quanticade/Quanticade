...
TUNABLE(double DEF_TIME_MULTIPLIER = 0.09448558505581064);
TUNABLE(double DEF_INC_MULTIPLIER = 0.8463092429726737);
TUNABLE(double MAX_TIME_MULTIPLIER = 0.7472506069450452);
TUNABLE(double SOFT_LIMIT_MULTIPLIER = 0.8068252880289201);
