...
double DEF_TIME_MULTIPLIER = 0.076;
double DEF_INC_MULTIPLIER = 0.88;
double MAX_TIME_MULTIPLIER = 0.697;
double HARD_LIMIT_MULTIPLIER = 3.161;
double SOFT_LIMIT_MULTIPLIER = 0.758;
