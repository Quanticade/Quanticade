...
double DEF_TIME_MULTIPLIER = 0.08781922898598217f;
double DEF_INC_MULTIPLIER = 0.8511647452650504f;
double MAX_TIME_MULTIPLIER = 0.7431182065415214f;
double SOFT_LIMIT_MULTIPLIER = 0.7777146662681907f;
