...
double DEF_TIME_MULTIPLIER = 0.088;
double DEF_INC_MULTIPLIER = 0.854;
double MAX_TIME_MULTIPLIER = 0.714;
double HARD_LIMIT_MULTIPLIER = 3.045;
double SOFT_LIMIT_MULTIPLIER = 0.724;
