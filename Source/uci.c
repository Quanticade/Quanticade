...
double DEF_TIME_MULTIPLIER = 0.08963660253604078;
double DEF_INC_MULTIPLIER = 0.8493720488859362;
double MAX_TIME_MULTIPLIER = 0.7515936143037917;
double SOFT_LIMIT_MULTIPLIER = 0.7983996717277189;
