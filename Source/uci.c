...
double DEF_TIME_MULTIPLIER = 0.07274849009009474;
double DEF_INC_MULTIPLIER = 0.8542030964352753;
double MAX_TIME_MULTIPLIER = 0.7686247768223657;
double HARD_LIMIT_MULTIPLIER = 3.017784248756386;
double SOFT_LIMIT_MULTIPLIER = 0.7732974757127113;
