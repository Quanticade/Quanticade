...
extern int MINOR_CORR_HISTORY_MULTIPLIER;
extern int MAJOR_CORR_HISTORY_MULTIPLIER;
...
void init_spsa_table(void) {
  ...
  SPSA_INT(MINOR_CORR_HISTORY_MULTIPLIER, 1);
  SPSA_INT(MAJOR_CORR_HISTORY_MULTIPLIER, 1);
