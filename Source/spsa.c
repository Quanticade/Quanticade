...
extern int SEE_QUIET_QUAD;
extern int SEE_QUIET_LINEAR;
extern int SEE_QUIET_CONST;
...
extern int BNFP_HISTORY_DIVIDER;
extern int BNFP_DEPTH;
extern int LDSE_DEPTH;
...
void init_spsa_table(void) {
  ...
  SPSA_INT_POISON(PROBCUT_DEPTH, 1);
  ...
  SPSA_INT(SEE_QUIET_QUAD, 1);
  SPSA_INT(SEE_QUIET_LINEAR, 1);
  SPSA_INT(SEE_QUIET_CONST, 1);
  ...
  SPSA_INT(BNFP_HISTORY_DIVIDER, 1);
  SPSA_INT_POISON(BNFP_DEPTH, 1);
