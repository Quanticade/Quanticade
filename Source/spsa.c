...
extern int LMR_BASE_QUIET;
extern int LMR_MULT_NOISY;
extern int LMR_BASE_NOISY;
extern int LMR_DEPTH_MULT_QUIET;
extern int LMR_DEPTH_BASE_QUIET;
extern int LMR_DEPTH_MULT_NOISY;
extern int LMR_DEPTH_BASE_NOISY;
...
void init_spsa_table(void) {
  ...
  SPSA_INT(LMR_MULT_QUIET, 1);
  SPSA_INT(LMR_BASE_QUIET, 1);
  SPSA_INT(LMR_MULT_NOISY, 1);
  SPSA_INT(LMR_BASE_NOISY, 1);
  SPSA_INT(LMR_DEPTH_MULT_QUIET, 1);
  SPSA_INT(LMR_DEPTH_BASE_QUIET, 1);
  SPSA_INT(LMR_DEPTH_MULT_NOISY, 1);
  SPSA_INT(LMR_DEPTH_BASE_NOISY, 1);
