...
extern int SEE_HISTORY_DIVISOR_QUIET;
extern int SEE_HISTORY_DIVISOR_CAPTURE;
extern int SE_DEPTH;
...
void init_spsa_table(void) {
  ...
  SPSA_INT(SEE_HISTORY_DIVISOR_QUIET, 1);
  SPSA_INT(SEE_HISTORY_DIVISOR_CAPTURE, 1);
  SPSA_INT_POISON(SE_DEPTH, 0);
  SPSA_INT(SE_DEPTH_REDUCTION, 0);
  SPSA_INT_MINMAX(SE_PV_DOUBLE_MARGIN, 1, 0, 300);
  SPSA_INT_MINMAX(SE_DOUBLE_MARGIN, 1, 0, 20);
